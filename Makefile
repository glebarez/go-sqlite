...
#TODO	windows_amd64:
#TODO		CCGO_CPP=x86_64-w64-mingw32-cpp TARGET_GOOS=windows TARGET_GOARCH=amd64 go generate 2>&1 | tee /tmp/log-generate-sqlite-windows-amd64
#TODO		GOOS=windows GOARCH=amd64 go build -v ./...
#TODO	
#TODO	windows_386:
#TODO		CCGO_CPP=i686-w64-mingw32-cpp TARGET_GOOS=windows TARGET_GOARCH=386 go generate 2>&1 | tee /tmp/log-generate-sqlite-windows-386
#TODO		GOOS=windows GOARCH=386 go build -v ./...
