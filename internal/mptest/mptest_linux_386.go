...
func Xmain(tls *crt.TLS, _argc int32, _argv **int8) (r0 int32) {
	...
	_nRep = i32(1)
	_iTmout = i32(0)
	*(**int8)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(0 /* X0 */))) = *(**int8)(unsafe.Pointer(uintptr((unsafe.Pointer)(_argv)) + 4*uintptr(i32(0))))
	*(*int32)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(68 /* X10 */))) = i32(1)
	if _argc < i32(2) {
		_usage(tls, *(**int8)(unsafe.Pointer(uintptr((unsafe.Pointer)(_argv)) + 4*uintptr(i32(0)))))
	}
	*(**int8)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(8 /* X2 */))) = *(**int8)(unsafe.Pointer(uintptr((unsafe.Pointer)(_argv)) + 4*uintptr(i32(1))))
	...
	_n = _argc - i32(2)
	bin.Xsqlite3_snprintf(tls, int32(u32(32)), (*int8)(unsafe.Pointer((*[32]int8)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g))+uintptr(32 /* X8 */))))), str(152), crt.Xgetpid(tls))
	...
	*(**int8)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(4 /* X1 */))) = _findOption(tls, (**int8)(unsafe.Pointer(uintptr(unsafe.Pointer(_argv))+uintptr(unsafe.Pointer((**int8)(unsafe.Pointer(uintptr(unsafe.Pointer((**int8)(unsafe.Pointer(uintptr(i32(2))))))*uintptr(unsafe.Pointer((**int8)(unsafe.Pointer(uintptr(4))))))))))), &_n, str(183), i32(1))
	...
	*(**int8)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(16 /* X4 */))) = _findOption(tls, (**int8)(unsafe.Pointer(uintptr(unsafe.Pointer(_argv))+uintptr(unsafe.Pointer((**int8)(unsafe.Pointer(uintptr(unsafe.Pointer((**int8)(unsafe.Pointer(uintptr(i32(2))))))*uintptr(unsafe.Pointer((**int8)(unsafe.Pointer(uintptr(4))))))))))), &_n, str(194), i32(1))
	*(**int8)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(24 /* X6 */))) = _findOption(tls, (**int8)(unsafe.Pointer(uintptr(unsafe.Pointer(_argv))+uintptr(unsafe.Pointer((**int8)(unsafe.Pointer(uintptr(unsafe.Pointer((**int8)(unsafe.Pointer(uintptr(i32(2))))))*uintptr(unsafe.Pointer((**int8)(unsafe.Pointer(uintptr(4))))))))))), &_n, str(201), i32(1))
	...
	if _zTrace != nil {
		*(*int32)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(68 /* X10 */))) = crt.Xatoi(tls, _zTrace)
	}
	if _findOption(tls, (**int8)(unsafe.Pointer(uintptr(unsafe.Pointer(_argv))+uintptr(unsafe.Pointer((**int8)(unsafe.Pointer(uintptr(unsafe.Pointer((**int8)(unsafe.Pointer(uintptr(i32(2))))))*uintptr(unsafe.Pointer((**int8)(unsafe.Pointer(uintptr(4))))))))))), &_n, str(211), i32(0)) != nil {
		*(*int32)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(68 /* X10 */))) = i32(0)
	}
	...
	*(*int32)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(72 /* X11 */))) = bool2int(_findOption(tls, (**int8)(unsafe.Pointer(uintptr(unsafe.Pointer(_argv))+uintptr(unsafe.Pointer((**int8)(unsafe.Pointer(uintptr(unsafe.Pointer((**int8)(unsafe.Pointer(uintptr(i32(2))))))*uintptr(unsafe.Pointer((**int8)(unsafe.Pointer(uintptr(4))))))))))), &_n, str(225), i32(0)) != nil)
	*(*int32)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(92 /* X16 */))) = bool2int(_findOption(tls, (**int8)(unsafe.Pointer(uintptr(unsafe.Pointer(_argv))+uintptr(unsafe.Pointer((**int8)(unsafe.Pointer(uintptr(unsafe.Pointer((**int8)(unsafe.Pointer(uintptr(i32(2))))))*uintptr(unsafe.Pointer((**int8)(unsafe.Pointer(uintptr(4))))))))))), &_n, str(234), i32(0)) != nil)
	if (_g.X4) != nil {
		*(**crt.XFILE)(unsafe.Pointer((*unsafe.Pointer)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(20 /* X5 */))))) = crt.Xfopen64(tls, _g.X4, str(239))
		goto _9
	}
	*(**crt.XFILE)(unsafe.Pointer((*unsafe.Pointer)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(20 /* X5 */))))) = (*crt.XFILE)(Xstderr)
_9:
	if (_g.X6) != nil {
		*(**crt.XFILE)(unsafe.Pointer((*unsafe.Pointer)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(28 /* X7 */))))) = crt.Xfopen64(tls, _g.X6, str(239))
		goto _11
	}
	*(**crt.XFILE)(unsafe.Pointer((*unsafe.Pointer)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(28 /* X7 */))))) = (*crt.XFILE)(Xstdout)
_11:
	...
	bin.Xsqlite3_snprintf(tls, int32(u32(32)), (*int8)(unsafe.Pointer((*[32]int8)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g))+uintptr(32 /* X8 */))))), str(268), crt.Xgetpid(tls), _iClient)
	goto _14
_12:
	_7_nTry = i32(0)
	if (_g.X10) <= i32(0) {
...
_14:
	_rc = bin.Xsqlite3_open_v2(tls, _g.X2, (**bin.Xsqlite3)(unsafe.Pointer((*unsafe.Pointer)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g))+uintptr(12 /* X3 */))))), _openFlags, _g.X1)
	if _rc != 0 {
	...
	*(*int32)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(88 /* X15 */))) = i32(10000)
	if (_g.X11) != 0 {
...
_53:
	...
	bin.Xsqlite3_sleep(tls, i32(10))
	*(*int32)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(88 /* X15 */))) = i32(0)
...
_60:
	...
	if _rc == i32(100) {
		{
			p := (*int32)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(80 /* X13 */)))
			*p = (*p) + bin.Xsqlite3_column_int(tls, _15_pStmt, i32(0))
			sink1 = *p
		}
		{
			p := (*int32)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(84 /* X14 */)))
...
func _fatalError(tls *crt.TLS, _zFormat *int8, args ...interface{}) {
	...
	_ap = nil
	bin.Xsqlite3_snprintf(tls, int32(u32(30)), (*int8)(unsafe.Pointer(&_zPrefix)), str(2070), unsafe.Pointer((*int8)(unsafe.Pointer((*[32]int8)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g))+uintptr(32 /* X8 */)))))))
...
func _logMessage(tls *crt.TLS, _zFormat *int8, args ...interface{}) {
	...
	_zMsg = bin.Xsqlite3_vmprintf(tls, _zFormat, _ap)
	_ap = nil
	bin.Xsqlite3_snprintf(tls, int32(u32(30)), (*int8)(unsafe.Pointer(&_zPrefix)), str(2145), unsafe.Pointer((*int8)(unsafe.Pointer((*[32]int8)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g))+uintptr(32 /* X8 */)))))))
	if (*crt.XFILE)(_g.X7) != nil {
		_printWithPrefix(tls, (*crt.XFILE)(_g.X7), (*int8)(unsafe.Pointer(&_zPrefix)), _zMsg)
		crt.Xfflush(tls, (*crt.XFILE)(_g.X7))
	}
...
func _errorMessage(tls *crt.TLS, _zFormat *int8, args ...interface{}) {
	...
	_zMsg = bin.Xsqlite3_vmprintf(tls, _zFormat, _ap)
	_ap = nil
	bin.Xsqlite3_snprintf(tls, int32(u32(30)), (*int8)(unsafe.Pointer(&_zPrefix)), str(2150), unsafe.Pointer((*int8)(unsafe.Pointer((*[32]int8)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g))+uintptr(32 /* X8 */)))))))
	if (*crt.XFILE)(_g.X7) != nil {
		_printWithPrefix(tls, (*crt.XFILE)(_g.X7), (*int8)(unsafe.Pointer(&_zPrefix)), _zMsg)
		crt.Xfflush(tls, (*crt.XFILE)(_g.X7))
	}
	...
	bin.Xsqlite3_free(tls, (unsafe.Pointer)(_zMsg))
	*(*int32)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(80 /* X13 */))) += 1
	_ = _zPrefix
}
...
func _stringAppend(tls *crt.TLS, _p *XString, _z *int8, _n int32) {
	...
	*(*int32)(unsafe.Pointer(uintptr((unsafe.Pointer)(_p)) + uintptr(8 /* X2 */))) = _1_nAlloc
_1:
...
_0:
	...
	if (_g.X13) != 0 || (_g.X14) != 0 {
		...
		*(*int32)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(80 /* X13 */))) = i32(0)
		*(*int32)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(84 /* X14 */))) = i32(0)
	}
...
_41:
	...
	*(*int32)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(84 /* X14 */))) += 1
	_stringReset(tls, &_sResult)
	goto _44
_36:
...
_97:
	...
	if crt.Xstrcmp(tls, (*int8)(unsafe.Pointer(&_zCmd)), str(3084)) == i32(0) {
		*(*int32)(unsafe.Pointer(uintptr((unsafe.Pointer)(&_g)) + uintptr(76 /* X12 */))) = func() int32 {
			if _nArg >= i32(1) {
...
func _stringReset(tls *crt.TLS, _p *XString) {
	...
	*(*int32)(unsafe.Pointer(uintptr((unsafe.Pointer)(_p)) + uintptr(4 /* X1 */))) = i32(0)
