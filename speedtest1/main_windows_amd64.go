...
func speedtest1_final(tls *libc.TLS) { /* speedtest1.c:413:6: */
	...
	if g.bVerify != 0 {
		...
		HashFinal(tls)
		for i = 0; i < 24; i++ {
			libc.Xprintf(tls, ts+2638 /* "%02x" */, libc.VaList(bp+56, int32(*(*uint8)(unsafe.Pointer((uintptr(unsafe.Pointer(&g)) + 3128 /* &.hash */ + 259 /* &.r */) + uintptr(i))))))
		}
...
func testset_rtree(tls *libc.TLS, p1 int32, p2 int32) { /* speedtest1.c:1427:6: */
		...
		for i = uint32(0); i < n; i++ {
			...
			if *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+116 /* &.zResult */) {
				fatal_error(tls, ts+9921, /* "Count disagree s..." */
					libc.VaList(bp+32, i, (i*iStep), ((i+uint32(1))*iStep), *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+116 /* &.zResult */)))
			}
		}
		speedtest1_end_test(tls)
	}
	...
	if g.bVerify != 0 {
		...
		for i = uint32(0); i < n; i++ {
			...
			if *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+116 /* &.zResult */) {
				fatal_error(tls, ts+9921, /* "Count disagree s..." */
					libc.VaList(bp+96, i, (i*iStep), ((i+uint32(1))*iStep), *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+116 /* &.zResult */)))
			}
		}
		speedtest1_end_test(tls)
	}
	...
	for i = uint32(0); i < n; i++ {
		...
		if *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+116 /* &.zResult */) {
			fatal_error(tls, ts+9921, /* "Count disagree s..." */
				libc.VaList(bp+160, i, (i*iStep), ((i+uint32(1))*iStep), *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+116 /* &.zResult */)))
		}
	}
	speedtest1_end_test(tls)
	...
	for i = 1; i < argc; i++ {
		...
		if int32(*(*int8)(unsafe.Pointer(z + uintptr(0)))) == '-' {
			...
			if libc.Xstrcmp(tls, z, ts+22782 /* "autovacuum" */) == 0 {
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+22803 /* "missing argument..." */, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				i++
				...
				if i >= (argc - 2) {
					fatal_error(tls, ts+22861 /* "missing argument..." */, libc.VaList(bp+40, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+22803 /* "missing argument..." */, libc.VaList(bp+56, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= (argc - 2) {
					fatal_error(tls, ts+22861 /* "missing argument..." */, libc.VaList(bp+88, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8)), ts+22983 /* "-" */) == 0 {
					...
					if g.hashFile == uintptr(0) {
						fatal_error(tls, ts+22988 /* "cannot open \"%s\"..." */, libc.VaList(bp+152, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
					}
				}
			} else if libc.Xstrcmp(tls, z, ts+23018 /* "pagesize" */) == 0 {
				if i >= (argc - 1) {
					fatal_error(tls, ts+22803 /* "missing argument..." */, libc.VaList(bp+168, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= (argc - 2) {
					fatal_error(tls, ts+22861 /* "missing argument..." */, libc.VaList(bp+184, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+22861 /* "missing argument..." */, libc.VaList(bp+200, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+22803 /* "missing argument..." */, libc.VaList(bp+216, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+22803 /* "missing argument..." */, libc.VaList(bp+232, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				i++
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+22803 /* "missing argument..." */, libc.VaList(bp+248, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+22803 /* "missing argument..." */, libc.VaList(bp+264, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))))
				}
				...
				libc.Xprintf(tls, uintptr(unsafe.Pointer(&zHelp)), libc.VaList(bp+280, *(*uintptr)(unsafe.Pointer(argv + uintptr(0)*8))))
				libc.Xexit(tls, 0)
			} else {
				fatal_error(tls, ts+23255, /* "unknown option: ..." */
					libc.VaList(bp+296, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8)), *(*uintptr)(unsafe.Pointer(argv + uintptr(0)*8))))
			}
		} else if zDbName == uintptr(0) {
			zDbName = *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8))
		} else {
			fatal_error(tls, ts+23296, /* "surplus argument..." */
				libc.VaList(bp+320, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*8)), *(*uintptr)(unsafe.Pointer(argv + uintptr(0)*8))))
		}
	}
