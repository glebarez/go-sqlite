...
func HashInit(tls *libc.TLS) { /* speedtest1.c:135:13: */
	...
	for k = uint32(0); k < uint32(256); k++ {
		*(*uint8)(unsafe.Pointer((uintptr(unsafe.Pointer(&g)) + 3100 /* &.hash */ + 3 /* &.s */) + uintptr(k))) = uint8(k)
	}
}
...
func HashUpdate(tls *libc.TLS, aData uintptr, nData uint32) { /* speedtest1.c:146:13: */
	...
	for k = uint32(0); k < nData; k++ {
		j = uint8(int32(j) + (int32(*(*uint8)(unsafe.Pointer((uintptr(unsafe.Pointer(&g)) + 3100 /* &.hash */ + 3 /* &.s */) + uintptr(i)))) + int32(*(*uint8)(unsafe.Pointer(aData + uintptr(k))))))
		t = *(*uint8)(unsafe.Pointer((uintptr(unsafe.Pointer(&g)) + 3100 /* &.hash */ + 3 /* &.s */) + uintptr(j)))
		*(*uint8)(unsafe.Pointer((uintptr(unsafe.Pointer(&g)) + 3100 /* &.hash */ + 3 /* &.s */) + uintptr(j))) = *(*uint8)(unsafe.Pointer((uintptr(unsafe.Pointer(&g)) + 3100 /* &.hash */ + 3 /* &.s */) + uintptr(i)))
		*(*uint8)(unsafe.Pointer((uintptr(unsafe.Pointer(&g)) + 3100 /* &.hash */ + 3 /* &.s */) + uintptr(i))) = t
		i++
	}
	g.hash.i = i
	g.hash.j = j
...
func HashFinal(tls *libc.TLS) { /* speedtest1.c:170:13: */
	...
	for k = uint32(0); k < uint32(32); k++ {
		i++
		t = *(*uint8)(unsafe.Pointer((uintptr(unsafe.Pointer(&g)) + 3100 /* &.hash */ + 3 /* &.s */) + uintptr(i)))
		j = uint8(int32(j) + (int32(t)))
		*(*uint8)(unsafe.Pointer((uintptr(unsafe.Pointer(&g)) + 3100 /* &.hash */ + 3 /* &.s */) + uintptr(i))) = *(*uint8)(unsafe.Pointer((uintptr(unsafe.Pointer(&g)) + 3100 /* &.hash */ + 3 /* &.s */) + uintptr(j)))
		*(*uint8)(unsafe.Pointer((uintptr(unsafe.Pointer(&g)) + 3100 /* &.hash */ + 3 /* &.s */) + uintptr(j))) = t
		t = uint8(int32(t) + (int32(*(*uint8)(unsafe.Pointer((uintptr(unsafe.Pointer(&g)) + 3100 /* &.hash */ + 3 /* &.s */) + uintptr(i))))))
		*(*uint8)(unsafe.Pointer((uintptr(unsafe.Pointer(&g)) + 3100 /* &.hash */ + 259 /* &.r */) + uintptr(k))) = *(*uint8)(unsafe.Pointer((uintptr(unsafe.Pointer(&g)) + 3100 /* &.hash */ + 3 /* &.s */) + uintptr(t)))
	}
}
...
func speedtest1_final(tls *libc.TLS) { /* speedtest1.c:413:6: */
	...
	if g.bVerify != 0 {
		...
		HashFinal(tls)
		for i = 0; i < 24; i++ {
			libc.Xprintf(tls, ts+2638 /* "%02x" */, libc.VaList(bp+40, int32(*(*uint8)(unsafe.Pointer((uintptr(unsafe.Pointer(&g)) + 3100 /* &.hash */ + 259 /* &.r */) + uintptr(i))))))
		}
			...
			if g.bVerify != 0 {
				...
				*(*uint8)(unsafe.Pointer(bp /* &zPrefix[0] */ + uintptr(1))) = uint8(*(*int8)(unsafe.Pointer(ts + 2736 /* "-IFTBN" */ + uintptr(eType))))
				...
				if eType == 2 {
					...
					// a floating-point value.
					*(*u64)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 84 /* &.nResByte */)) += (uint64(2))
				} else if eType == 4 {
					...
					*(*u64)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 84 /* &.nResByte */)) += (u64((nBlob * 2) + 2))
				} else {
					HashUpdate(tls, z, uint32(len))
					*(*u64)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 84 /* &.nResByte */)) += (u64(len + 2))
				}
			}
			if (uint32(g.nResult + len)) < (uint32(unsafe.Sizeof([3000]int8{})) - uint32(2)) {
				if g.nResult > 0 {
					*(*int8)(unsafe.Pointer((uintptr(unsafe.Pointer(&g)) + 96 /* &.zResult */) + uintptr(libc.PostIncInt32(&g.nResult, 1)))) = int8(' ')
				}
				libc.Xmemcpy(tls, ((uintptr(unsafe.Pointer(&g)) + 96 /* &.zResult */) + uintptr(g.nResult)), z, (uint32(len + 1)))
				*(*int32)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 92 /* &.nResult */)) += (len)
			}
		}
	}
	if g.bReprepare != 0 {
...
func testset_rtree(tls *libc.TLS, p1 int32, p2 int32) { /* speedtest1.c:1427:6: */
	...
	for i = uint32(0); i < n; i++ {
		...
		speedtest1_run(tls)
		*(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) = libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+96 /* &.zResult */)
	}
	speedtest1_end_test(tls)
	...
	if g.bVerify != 0 {
		...
		for i = uint32(0); i < n; i++ {
			...
			sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 2, (int32((i + uint32(1)) * iStep)))
			speedtest1_run(tls)
			if *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+96 /* &.zResult */) {
				fatal_error(tls, ts+9921, /* "Count disagree s..." */
					libc.VaList(bp+16, i, (i*iStep), ((i+uint32(1))*iStep), *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+96 /* &.zResult */)))
			}
		}
		speedtest1_end_test(tls)
	}
	...
	if g.bVerify != 0 {
		...
		for i = uint32(0); i < n; i++ {
			...
			if *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+96 /* &.zResult */) {
				fatal_error(tls, ts+9921, /* "Count disagree s..." */
					libc.VaList(bp+64, i, (i*iStep), ((i+uint32(1))*iStep), *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+96 /* &.zResult */)))
			}
		}
		speedtest1_end_test(tls)
	}
	...
	for i = uint32(0); i < n; i++ {
		...
		if *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+96 /* &.zResult */) {
			fatal_error(tls, ts+9921, /* "Count disagree s..." */
				libc.VaList(bp+112, i, (i*iStep), ((i+uint32(1))*iStep), *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+96 /* &.zResult */)))
		}
	}
	speedtest1_end_test(tls)
...
func xCompileOptions(tls *libc.TLS, pCtx uintptr, nVal int32, azVal uintptr, azCol uintptr) int32 { /* speedtest1.c:2138:12: */
	...
	libc.Xprintf(tls, ts+22985 /* "-- Compile optio..." */, libc.VaList(bp, *(*uintptr)(unsafe.Pointer(azVal + uintptr(0)*4))))
	return 0
}
	...
	for i = 1; i < argc; i++ {
		...
		if int32(*(*int8)(unsafe.Pointer(z + uintptr(0)))) == '-' {
			...
			if libc.Xstrcmp(tls, z, ts+23055 /* "autovacuum" */) == 0 {
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+23076 /* "missing argument..." */, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				i++
				...
				if i >= (argc - 2) {
					fatal_error(tls, ts+23134 /* "missing argument..." */, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+23076 /* "missing argument..." */, libc.VaList(bp+32, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				zJMode = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4))
			} else if libc.Xstrcmp(tls, z, ts+23178 /* "key" */) == 0 {
				if i >= (argc - 1) {
					fatal_error(tls, ts+23076 /* "missing argument..." */, libc.VaList(bp+40, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				zKey = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4))
			} else if libc.Xstrcmp(tls, z, ts+23182 /* "lookaside" */) == 0 {
				if i >= (argc - 2) {
					fatal_error(tls, ts+23134 /* "missing argument..." */, libc.VaList(bp+48, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+23076 /* "missing argument..." */, libc.VaList(bp+64, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+23076 /* "missing argument..." */, libc.VaList(bp+72, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				i++
				if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), ts+23256 /* "-" */) == 0 {
					g.hashFile = libc.Xstdout
				} else {
					g.hashFile = libc.Xfopen64(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), ts+23258 /* "wb" */)
					if g.hashFile == uintptr(0) {
						fatal_error(tls, ts+23261 /* "cannot open \"%s\"..." */, libc.VaList(bp+80, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
					}
				}
			} else if libc.Xstrcmp(tls, z, ts+23291 /* "pagesize" */) == 0 {
				if i >= (argc - 1) {
					fatal_error(tls, ts+23076 /* "missing argument..." */, libc.VaList(bp+88, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= (argc - 2) {
					fatal_error(tls, ts+23134 /* "missing argument..." */, libc.VaList(bp+96, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+23134 /* "missing argument..." */, libc.VaList(bp+104, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+23076 /* "missing argument..." */, libc.VaList(bp+112, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+23076 /* "missing argument..." */, libc.VaList(bp+120, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				i++
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+23076 /* "missing argument..." */, libc.VaList(bp+128, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+23076 /* "missing argument..." */, libc.VaList(bp+136, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				libc.Xprintf(tls, uintptr(unsafe.Pointer(&zHelp)), libc.VaList(bp+144, *(*uintptr)(unsafe.Pointer(argv + uintptr(0)*4))))
				libc.Xexit(tls, 0)
			} else {
				fatal_error(tls, ts+23528, /* "unknown option: ..." */
					libc.VaList(bp+152, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), *(*uintptr)(unsafe.Pointer(argv + uintptr(0)*4))))
			}
		} else if zDbName == uintptr(0) {
			zDbName = *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))
		} else {
			fatal_error(tls, ts+23569, /* "surplus argument..." */
				libc.VaList(bp+168, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), *(*uintptr)(unsafe.Pointer(argv + uintptr(0)*4))))
		}
	}
