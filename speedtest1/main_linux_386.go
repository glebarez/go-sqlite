// Code generated by 'ccgo -export-defines "" -o speedtest1/main_linux_386.go -trace-translation-units testdata/sqlite-src-3370000/test/speedtest1.c -Itestdata/sqlite-amalgamation-3370000 -l modernc.org/sqlite/lib -DNDEBUG -DHAVE_USLEEP -DLONGDOUBLE_TYPE=double -DSQLITE_CORE -DSQLITE_ENABLE_COLUMN_METADATA -DSQLITE_ENABLE_FTS5 -DSQLITE_ENABLE_GEOPOLY -DSQLITE_ENABLE_JSON1 -DSQLITE_ENABLE_MEMORY_MANAGEMENT -DSQLITE_ENABLE_OFFSET_SQL_FUNC -DSQLITE_ENABLE_PREUPDATE_HOOK -DSQLITE_ENABLE_RBU -DSQLITE_ENABLE_RTREE -DSQLITE_ENABLE_SESSION -DSQLITE_ENABLE_SNAPSHOT -DSQLITE_ENABLE_STAT4 -DSQLITE_ENABLE_UNLOCK_NOTIFY -DSQLITE_LIKE_DOESNT_MATCH_BLOBS -DSQLITE_MUTEX_APPDEF=1 -DSQLITE_MUTEX_NOOP -DSQLITE_SOUNDEX -DSQLITE_THREADSAFE=1 -DSQLITE_OS_UNIX=1', DO NOT EDIT.
...
var zHelp = *(*[2263]int8)(unsafe.Pointer(ts /* "Usage: %s [--opt..." */)) /* speedtest1.c:6:19 */
...
// is not a hex digit.
func hexDigitValue(tls *libc.TLS, c int8) int32 { /* speedtest1.c:197:12: */
...
var zDots = *(*[72]int8)(unsafe.Pointer(ts + 2560 /* "..................." */)) /* speedtest1.c:371:19 */
	...
	for sqlite3.Xsqlite3_step(tls, g.pStmt) == SQLITE_ROW {
		...
		for i = 0; i < n; i++ {
			...
			if g.bVerify != 0 {
				...
				*(*uint8)(unsafe.Pointer(bp /* &zPrefix[0] */ + 1)) = uint8(*(*int8)(unsafe.Pointer(ts + 2853 /* "-IFTBN" */ + uintptr(eType))))
				if g.nResByte != 0 {
				...
				if eType == SQLITE_FLOAT {
					...
					*(*u64)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 88)) += uint64(2)
					...
					for iBlob = 0; iBlob < nBlob; iBlob++ {
						*(*uint8)(unsafe.Pointer(bp + 2 /* &zChar[0] */)) = uint8(*(*int8)(unsafe.Pointer(ts + 2860 /* "0123456789abcdef" */ + uintptr(int32(*(*uint8)(unsafe.Pointer(aBlob + uintptr(iBlob))))>>4))))
						*(*uint8)(unsafe.Pointer(bp + 2 /* &zChar[0] */ + 1)) = uint8(*(*int8)(unsafe.Pointer(ts + 2860 /* "0123456789abcdef" */ + uintptr(int32(*(*uint8)(unsafe.Pointer(aBlob + uintptr(iBlob))))&15))))
			...
			if uint32(g.nResult+len) < uint32(unsafe.Sizeof([3000]int8{}))-uint32(2) {
				if g.nResult > 0 {
					*(*int8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 100 + uintptr(libc.PostIncInt32(&g.nResult, 1)))) = int8(' ')
				}
...
func testset_main(tls *libc.TLS) { /* speedtest1.c:697:6: */
	...
	*(*int8)(unsafe.Pointer(bp + 568 /* &zNum[0] */)) = int8(0)
	...
	for i = 1; i <= n; i++ {
		if (i-1)%g.nRepeat == 0 {
			x1 = swizzle(tls, uint32(i), uint32(maxb))
			len = speedtest1_numbername(tls, x1, bp+568 /* &zNum[0] */, int32(uint32(unsafe.Sizeof([2000]int8{}))-uint32(1)))
		}
...
*(*[120]int8)(unsafe.Pointer(ts + 20878 /* "IBBIIITIVVITBTBF..." */)) /* speedtest1.c:1620:21 */
...
func displayLinuxIoStats(tls *libc.TLS, out uintptr) { /* speedtest1.c:2105:13: */
	...
	sqlite3.Xsqlite3_snprintf(tls, int32(unsafe.Sizeof([200]int8{})), bp+24 /* &z[0] */, ts+22833 /* "/proc/%d/io" */, libc.VaList(bp, libc.Xgetpid(tls)))
