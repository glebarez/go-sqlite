...
func speedtest1_final(tls *libc.TLS) { /* speedtest1.c:415:6: */
	...
	if g.bVerify != 0 {
		...
		HashFinal(tls)
		for i = 0; i < 24; i++ {
			libc.Xprintf(tls, ts+2698 /* "%02x" */, libc.VaList(bp+40, int32(*(*uint8)(unsafe.Pointer((uintptr(unsafe.Pointer(&g)) + 3104 /* &.hash */ + 259 /* &.r */) + uintptr(i))))))
		}
	...
	for i = 1; i < argc; i++ {
		...
		if int32(*(*int8)(unsafe.Pointer(z))) == '-' {
			...
			if libc.Xstrcmp(tls, z, ts+23115 /* "autovacuum" */) == 0 {
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+23136 /* "missing argument..." */, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				i++
				...
				if i >= (argc - 2) {
					fatal_error(tls, ts+23194 /* "missing argument..." */, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+23136 /* "missing argument..." */, libc.VaList(bp+32, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				zJMode = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4))
			} else if libc.Xstrcmp(tls, z, ts+23238 /* "key" */) == 0 {
				if i >= (argc - 1) {
					fatal_error(tls, ts+23136 /* "missing argument..." */, libc.VaList(bp+40, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				zKey = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4))
			} else if libc.Xstrcmp(tls, z, ts+23242 /* "lookaside" */) == 0 {
				if i >= (argc - 2) {
					fatal_error(tls, ts+23194 /* "missing argument..." */, libc.VaList(bp+48, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+23136 /* "missing argument..." */, libc.VaList(bp+64, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+23136 /* "missing argument..." */, libc.VaList(bp+72, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				i++
				if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), ts+23316 /* "-" */) == 0 {
					g.hashFile = libc.Xstdout
				} else {
					g.hashFile = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), ts+23318 /* "wb" */)
					if g.hashFile == uintptr(0) {
						fatal_error(tls, ts+23321 /* "cannot open \"%s\"..." */, libc.VaList(bp+80, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
					}
				}
			} else if libc.Xstrcmp(tls, z, ts+23351 /* "pagesize" */) == 0 {
				if i >= (argc - 1) {
					fatal_error(tls, ts+23136 /* "missing argument..." */, libc.VaList(bp+88, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= (argc - 2) {
					fatal_error(tls, ts+23194 /* "missing argument..." */, libc.VaList(bp+96, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+23194 /* "missing argument..." */, libc.VaList(bp+104, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+23136 /* "missing argument..." */, libc.VaList(bp+112, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+23136 /* "missing argument..." */, libc.VaList(bp+120, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				i++
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+23136 /* "missing argument..." */, libc.VaList(bp+128, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+23136 /* "missing argument..." */, libc.VaList(bp+136, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				if i >= (argc - 1) {
					fatal_error(tls, ts+23136 /* "missing argument..." */, libc.VaList(bp+144, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
