// Code generated by 'ccgo -export-defines "" -o speedtest1/main_linux_arm.go -trace-translation-units testdata/sqlite-src-3370000/test/speedtest1.c -Itestdata/sqlite-amalgamation-3370000 -l modernc.org/sqlite/lib -DNDEBUG -DHAVE_USLEEP -DLONGDOUBLE_TYPE=double -DSQLITE_CORE -DSQLITE_ENABLE_COLUMN_METADATA -DSQLITE_ENABLE_FTS5 -DSQLITE_ENABLE_GEOPOLY -DSQLITE_ENABLE_JSON1 -DSQLITE_ENABLE_MEMORY_MANAGEMENT -DSQLITE_ENABLE_OFFSET_SQL_FUNC -DSQLITE_ENABLE_PREUPDATE_HOOK -DSQLITE_ENABLE_RBU -DSQLITE_ENABLE_RTREE -DSQLITE_ENABLE_SESSION -DSQLITE_ENABLE_SNAPSHOT -DSQLITE_ENABLE_STAT4 -DSQLITE_ENABLE_UNLOCK_NOTIFY -DSQLITE_LIKE_DOESNT_MATCH_BLOBS -DSQLITE_MUTEX_APPDEF=1 -DSQLITE_MUTEX_NOOP -DSQLITE_SOUNDEX -DSQLITE_THREADSAFE=1 -DSQLITE_OS_UNIX=1', DO NOT EDIT.
...
var zHelp = *(*[2263]uint8)(unsafe.Pointer(ts /* "Usage: %s [--opt..." */)) /* speedtest1.c:6:19 */
...
type u64 = sqlite3_uint64 /* speedtest1.c:68:24 */
...
// State structure for a Hash hash in progress
type HashContext = HashContext1 /* speedtest1.c:73:28 */
...
// All global state is held in this structure
var g Global /* speedtest1.c:110:3: */

// Return " TEMP" or "", as appropriate for creating a table.
func isTemp(tls *libc.TLS, N int32) uintptr { /* speedtest1.c:114:19: */
	if g.eTemp >= N {
		return ts + 2263 /* " TEMP" */
	}
	return ts + 2269 /* "" */
...
func fatal_error(tls *libc.TLS, zMsg uintptr, va uintptr) { /* speedtest1.c:119:13: */
	var ap va_list
	_ = ap
	ap = va
...
func HashInit(tls *libc.TLS) { /* speedtest1.c:138:13: */
	var k uint32
	g.hash.i = uint8(0)
	g.hash.j = uint8(0)
	for k = uint32(0); k < uint32(256); k++ {
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3104 + 3 + uintptr(k))) = uint8(k)
	}
}

// Make consecutive calls to the HashUpdate function to add new content
// to the hash
func HashUpdate(tls *libc.TLS, aData uintptr, nData uint32) { /* speedtest1.c:149:13: */
	var t uint8
	...
	for k = uint32(0); k < nData; k++ {
		j = uint8(int32(j) + (int32(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3104 + 3 + uintptr(i)))) + int32(*(*uint8)(unsafe.Pointer(aData + uintptr(k))))))
		t = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3104 + 3 + uintptr(j)))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3104 + 3 + uintptr(j))) = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3104 + 3 + uintptr(i)))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3104 + 3 + uintptr(i))) = t
		i++
	}
	g.hash.i = i
	g.hash.j = j
...
func HashFinal(tls *libc.TLS) { /* speedtest1.c:173:13: */
	var k uint32
	var t uint8
	var i uint8
	var j uint8
	...
	for k = uint32(0); k < uint32(32); k++ {
		i++
		t = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3104 + 3 + uintptr(i)))
		j = uint8(int32(j) + int32(t))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3104 + 3 + uintptr(i))) = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3104 + 3 + uintptr(j)))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3104 + 3 + uintptr(j))) = t
		t = uint8(int32(t) + int32(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3104 + 3 + uintptr(i)))))
		*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3104 + 259 + uintptr(k))) = *(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3104 + 3 + uintptr(t)))
	}
}
...
// is not a hex digit.
func hexDigitValue(tls *libc.TLS, c uint8) int32 { /* speedtest1.c:197:12: */
...
func integerValue(tls *libc.TLS, zArg uintptr) int32 { /* speedtest1.c:213:12: */
	...
	if v > int64(0x7fffffff) {
		fatal_error(tls, ts+2270 /* "parameter too la..." */, 0)
	}
	return func() int32 {
		if isNeg != 0 {
			return int32(-v)
...
func speedtest1_timestamp(tls *libc.TLS) sqlite3_int64 { /* speedtest1.c:258:15: */
	bp := tls.Alloc(16)
	defer tls.Free(16)
...
var clockVfs uintptr = uintptr(0) /* speedtest1.c:262:22 */

// Return a pseudo-random unsigned integer
func speedtest1_random(tls *libc.TLS) uint32 { /* speedtest1.c:280:14: */
...
func swizzle(tls *libc.TLS, in uint32, limit uint32) uint32 { /* speedtest1.c:289:10: */
...
func roundup_allones(tls *libc.TLS, limit uint32) uint32 { /* speedtest1.c:301:10: */
...
func speedtest1_numbername(tls *libc.TLS, n uint32, zOut uintptr, nOut int32) int32 { /* speedtest1.c:315:5: */
	bp := tls.Alloc(24)
	defer tls.Free(24)
	...
	if n >= uint32(1000000000) {
		...
		sqlite3.Xsqlite3_snprintf(tls, nOut-i, zOut+uintptr(i), ts+2334 /* " billion" */, 0)
	...
	if n >= uint32(1000000) {
		...
		sqlite3.Xsqlite3_snprintf(tls, nOut-i, zOut+uintptr(i), ts+2343 /* " million" */, 0)
		i = i + int32(libc.Xstrlen(tls, zOut+uintptr(i)))
		n = n % uint32(1000000)
	}
	if n >= uint32(1000) {
		...
		sqlite3.Xsqlite3_snprintf(tls, nOut-i, zOut+uintptr(i), ts+2352 /* " thousand" */, 0)
		i = i + int32(libc.Xstrlen(tls, zOut+uintptr(i)))
		n = n % uint32(1000)
	}
	if n >= uint32(100) {
		...
		sqlite3.Xsqlite3_snprintf(tls, nOut-i, zOut+uintptr(i), ts+2362 /* "%s hundred" */, libc.VaList(bp, ones[n/uint32(100)]))
		i = i + int32(libc.Xstrlen(tls, zOut+uintptr(i)))
		n = n % uint32(100)
	}
	if n >= uint32(20) {
		...
		sqlite3.Xsqlite3_snprintf(tls, nOut-i, zOut+uintptr(i), ts+2373 /* "%s" */, libc.VaList(bp+8, tens[n/uint32(10)]))
		i = i + int32(libc.Xstrlen(tls, zOut+uintptr(i)))
		n = n % uint32(10)
	}
	if n > uint32(0) {
		...
		sqlite3.Xsqlite3_snprintf(tls, nOut-i, zOut+uintptr(i), ts+2373 /* "%s" */, libc.VaList(bp+16, ones[n]))
		i = i + int32(libc.Xstrlen(tls, zOut+uintptr(i)))
	}
	if i == 0 {
		sqlite3.Xsqlite3_snprintf(tls, nOut-i, zOut+uintptr(i), ts+2376 /* "zero" */, 0)
		i = i + int32(libc.Xstrlen(tls, zOut+uintptr(i)))
	}
	return i
}

var ones = [20]uintptr{ts + 2376 /* "zero" */, ts + 2381 /* "one" */, ts + 2385 /* "two" */, ts + 2389 /* "three" */, ts + 2395 /* "four" */, ts + 2400, /* "five" */
	ts + 2405 /* "six" */, ts + 2409 /* "seven" */, ts + 2415 /* "eight" */, ts + 2421 /* "nine" */, ts + 2426 /* "ten" */, ts + 2430 /* "eleven" */, ts + 2437, /* "twelve" */
	ts + 2444 /* "thirteen" */, ts + 2453 /* "fourteen" */, ts + 2462 /* "fifteen" */, ts + 2470 /* "sixteen" */, ts + 2478, /* "seventeen" */
																	ts + 2488 /* "eighteen" */, ts + 2497 /* "nineteen" */} /* speedtest1.c:316:21 */
var tens = [10]uintptr{ts + 2269 /* "" */, ts + 2426 /* "ten" */, ts + 2506 /* "twenty" */, ts + 2513 /* "thirty" */, ts + 2520, /* "forty" */
	ts + 2526 /* "fifty" */, ts + 2532 /* "sixty" */, ts + 2538 /* "seventy" */, ts + 2546 /* "eighty" */, ts + 2553 /* "ninety" */} /* speedtest1.c:320:21 */

// Start a new test case
var zDots = *(*[72]uint8)(unsafe.Pointer(ts + 2560 /* "..................." */)) /* speedtest1.c:371:19 */

func speedtest1_begin_test(tls *libc.TLS, iTestNum int32, zTestName uintptr, va uintptr) { /* speedtest1.c:373:6: */
	bp := tls.Alloc(64)
	defer tls.Free(64)
	...
	if g.bSqlOnly != 0 {
		libc.Xprintf(tls, ts+2632 /* "/* %4d - %s%.*s ..." */, libc.VaList(bp, iTestNum, zName, NAMEWIDTH-n, uintptr(unsafe.Pointer(&zDots))))
	} else {
		libc.Xprintf(tls, ts+2652 /* "%4d - %s%.*s " */, libc.VaList(bp+32, iTestNum, zName, NAMEWIDTH-n, uintptr(unsafe.Pointer(&zDots))))
...
func speedtest1_end_test(tls *libc.TLS) { /* speedtest1.c:402:6: */
	bp := tls.Alloc(16)
	defer tls.Free(16)

	var iElapseTime sqlite3_int64 = speedtest1_timestamp(tls) - g.iStart
	if g.doCheckpoint != 0 {
		speedtest1_exec(tls, ts+2666 /* "PRAGMA wal_check..." */, 0)
	}
	if !(g.bSqlOnly != 0) {
		*(*sqlite3_int64)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 16)) += iElapseTime
		libc.Xprintf(tls, ts+2689 /* "%4d.%03ds\n" */, libc.VaList(bp, int32(iElapseTime/int64(1000)), int32(iElapseTime%int64(1000))))
	}
	if g.pStmt != 0 {
...
func speedtest1_final(tls *libc.TLS) { /* speedtest1.c:416:6: */
	bp := tls.Alloc(48)
	defer tls.Free(48)

	if !(g.bSqlOnly != 0) {
		libc.Xprintf(tls, ts+2700 /* "       TOTAL%.*s..." */, libc.VaList(bp, NAMEWIDTH-5, uintptr(unsafe.Pointer(&zDots)),
			int32(g.iTotal/int64(1000)), int32(g.iTotal%int64(1000))))
	}
	if g.bVerify != 0 {
		var i int32
		libc.Xprintf(tls, ts+2728 /* "Verification Has..." */, libc.VaList(bp+32, g.nResByte))
		HashUpdate(tls, ts+2753 /* "\n" */, uint32(1))
		HashFinal(tls)
		for i = 0; i < 24; i++ {
			libc.Xprintf(tls, ts+2755 /* "%02x" */, libc.VaList(bp+40, int32(*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 3104 + 259 + uintptr(i))))))
		}
		if g.hashFile != 0 && g.hashFile != libc.Xstdout {
			libc.Xfclose(tls, g.hashFile)
		}
		libc.Xprintf(tls, ts+2753 /* "\n" */, 0)
	}
}

// Print an SQL statement to standard output
func printSql(tls *libc.TLS, zSql uintptr) { /* speedtest1.c:439:13: */
	bp := tls.Alloc(32)
	defer tls.Free(32)
	...
	if g.bExplain != 0 {
		libc.Xprintf(tls, ts+2760 /* "EXPLAIN " */, 0)
	}
	libc.Xprintf(tls, ts+2769 /* "%.*s;\n" */, libc.VaList(bp, n, zSql))
	if g.bExplain != 0 &&
...
// of doing so.
func speedtest1_shrink_memory(tls *libc.TLS) { /* speedtest1.c:459:6: */
	if g.bMemShrink != 0 {
...
// Run SQL
func speedtest1_exec(tls *libc.TLS, zFormat uintptr, va uintptr) { /* speedtest1.c:466:6: */
	bp := tls.Alloc(28)
	defer tls.Free(28)
...
// the caller.
func speedtest1_once(tls *libc.TLS, zFormat uintptr, va uintptr) uintptr { /* speedtest1.c:488:6: */
	bp := tls.Alloc(20)
	defer tls.Free(20)
	...
	if g.bSqlOnly != 0 {
		...
		if sqlite3.Xsqlite3_step(tls, *(*uintptr)(unsafe.Pointer(bp + 16))) == SQLITE_ROW {
			...
			if z != 0 {
				zResult = sqlite3.Xsqlite3_mprintf(tls, ts+2373 /* "%s" */, libc.VaList(bp+8, z))
			}
		}
...
func speedtest1_prepare(tls *libc.TLS, zFormat uintptr, va uintptr) { /* speedtest1.c:515:6: */
	bp := tls.Alloc(8)
	defer tls.Free(8)
...
func speedtest1_run(tls *libc.TLS) { /* speedtest1.c:535:6: */
	bp := tls.Alloc(8)
	defer tls.Free(8)
	...
	for sqlite3.Xsqlite3_step(tls, g.pStmt) == SQLITE_ROW {
		...
		for i = 0; i < n; i++ {
			...
			if g.bVerify != 0 {
				...
				*(*uint8)(unsafe.Pointer(bp /* &zPrefix[0] */ + 1)) = uint8(*(*uint8)(unsafe.Pointer(ts + 2853 /* "-IFTBN" */ + uintptr(eType))))
				if g.nResByte != 0 {
				...
				if eType == SQLITE_FLOAT {
					...
					// a floating-point value.
					*(*u64)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 88)) += uint64(2)
					...
					for iBlob = 0; iBlob < nBlob; iBlob++ {
						*(*uint8)(unsafe.Pointer(bp + 2 /* &zChar[0] */)) = uint8(*(*uint8)(unsafe.Pointer(ts + 2860 /* "0123456789abcdef" */ + uintptr(int32(*(*uint8)(unsafe.Pointer(aBlob + uintptr(iBlob))))>>4))))
						*(*uint8)(unsafe.Pointer(bp + 2 /* &zChar[0] */ + 1)) = uint8(*(*uint8)(unsafe.Pointer(ts + 2860 /* "0123456789abcdef" */ + uintptr(int32(*(*uint8)(unsafe.Pointer(aBlob + uintptr(iBlob))))&15))))
						HashUpdate(tls, bp+2 /* &zChar[0] */, uint32(2))
					}
					*(*u64)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 88)) += u64(nBlob*2 + 2)
				} else {
					HashUpdate(tls, z, uint32(len))
					*(*u64)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 88)) += u64(len + 2)
				}
			}
			if uint32(g.nResult+len) < uint32(unsafe.Sizeof([3000]uint8{}))-uint32(2) {
				if g.nResult > 0 {
					*(*uint8)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 100 + uintptr(libc.PostIncInt32(&g.nResult, 1)))) = uint8(' ')
				}
				libc.Xmemcpy(tls, uintptr(unsafe.Pointer(&g))+100+uintptr(g.nResult), z, uint32(len+1))
				*(*int32)(unsafe.Pointer(uintptr(unsafe.Pointer(&g)) + 96)) += len
			}
		}
	}
	if g.bReprepare != 0 {
...
func traceCallback(tls *libc.TLS, NotUsed uintptr, zSql uintptr) { /* speedtest1.c:602:13: */
	bp := tls.Alloc(16)
	defer tls.Free(16)
...
func testset_main(tls *libc.TLS) { /* speedtest1.c:697:6: */
	bp := tls.Alloc(2568)
	defer tls.Free(2568)
	...
	*(*uint8)(unsafe.Pointer(bp + 568 /* &zNum[0] */)) = uint8(0)
	...
	speedtest1_begin_test(tls, 100, ts+2877 /* "%d INSERTs into ..." */, libc.VaList(bp, n))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_exec(tls, ts+2919, /* "CREATE%s TABLE z..." */
		libc.VaList(bp+8, isTemp(tls, 9), g.zNN, g.zNN, g.zNN))
	speedtest1_prepare(tls, ts+2977 /* "INSERT INTO z1 V..." */, libc.VaList(bp+40, n))
	for i = 1; i <= n; i++ {
	...
	speedtest1_exec(tls, ts+3023 /* "COMMIT" */, 0)
	speedtest1_end_test(tls)

	n = sz
	speedtest1_begin_test(tls, 110, ts+3030 /* "%d ordered INSER..." */, libc.VaList(bp+48, n))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_exec(tls,
		ts+3067, /* "CREATE%s TABLE z..." */
		libc.VaList(bp+56, isTemp(tls, 5), g.zNN, g.zPK, g.zNN, g.zNN, g.zWR))
	speedtest1_prepare(tls, ts+3130 /* "INSERT INTO z2 V..." */, libc.VaList(bp+104, n))
	for i = 1; i <= n; i++ {
		x1 = swizzle(tls, uint32(i), uint32(maxb))
		speedtest1_numbername(tls, x1, bp+568 /* &zNum[0] */, int32(unsafe.Sizeof([2000]uint8{})))
	...
	n = sz
	speedtest1_begin_test(tls, 120, ts+3175 /* "%d unordered INS..." */, libc.VaList(bp+112, n))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_exec(tls,
		ts+3214, /* "CREATE%s TABLE t..." */
		libc.VaList(bp+120, isTemp(tls, 3), g.zNN, g.zPK, g.zNN, g.zNN, g.zWR))
	speedtest1_prepare(tls, ts+3277 /* "INSERT INTO t3 V..." */, libc.VaList(bp+168, n))
	for i = 1; i <= n; i++ {
		x1 = swizzle(tls, uint32(i), uint32(maxb))
		speedtest1_numbername(tls, x1, bp+568 /* &zNum[0] */, int32(unsafe.Sizeof([2000]uint8{})))
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 2, i)
	...
	n = 25
	speedtest1_begin_test(tls, 130, ts+3322 /* "%d SELECTS, nume..." */, libc.VaList(bp+176, n))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_prepare(tls,

		ts+3361 /* "SELECT count(*),..." */, libc.VaList(bp+184, n))
	for i = 1; i <= n; i++ {
		if (i-1)%g.nRepeat == 0 {
	...
	n = 10
	speedtest1_begin_test(tls, 140, ts+3466 /* "%d SELECTS, LIKE..." */, libc.VaList(bp+192, n))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_prepare(tls,

		ts+3494 /* "SELECT count(*),..." */, libc.VaList(bp+200, n))
	for i = 1; i <= n; i++ {
		if (i-1)%g.nRepeat == 0 {
			x1 = speedtest1_random(tls) % uint32(maxb)
	...
	n = 10
	speedtest1_begin_test(tls, 142, ts+3589 /* "%d SELECTS w/ORD..." */, libc.VaList(bp+208, n))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_prepare(tls,

		ts+3622 /* "SELECT a, b, c F..." */, libc.VaList(bp+216, n))
	for i = 1; i <= n; i++ {
		if (i-1)%g.nRepeat == 0 {
			x1 = speedtest1_random(tls) % uint32(maxb)
			*(*uint8)(unsafe.Pointer(bp + 568 /* &zNum[0] */)) = uint8('%')
	...
	n = 10 // g.szTest/5;
	speedtest1_begin_test(tls, 145, ts+3686 /* "%d SELECTS w/ORD..." */, libc.VaList(bp+224, n))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_prepare(tls,

		ts+3729 /* "SELECT a, b, c F..." */, libc.VaList(bp+232, n))
	for i = 1; i <= n; i++ {
		if (i-1)%g.nRepeat == 0 {
			x1 = speedtest1_random(tls) % uint32(maxb)
			*(*uint8)(unsafe.Pointer(bp + 568 /* &zNum[0] */)) = uint8('%')
	...
	speedtest1_begin_test(tls, 150, ts+3802 /* "CREATE INDEX fiv..." */, 0)
	speedtest1_exec(tls, ts+3826 /* "BEGIN;" */, 0)
	speedtest1_exec(tls, ts+3833 /* "CREATE UNIQUE IN..." */, 0)
	speedtest1_exec(tls, ts+3867 /* "CREATE INDEX t1c..." */, 0)
	speedtest1_exec(tls, ts+3894 /* "CREATE UNIQUE IN..." */, 0)
	speedtest1_exec(tls, ts+3928 /* "CREATE INDEX t2c..." */, 0)
	speedtest1_exec(tls, ts+3960 /* "CREATE INDEX t3b..." */, 0)
	speedtest1_exec(tls, ts+3990 /* "COMMIT;" */, 0)
	speedtest1_end_test(tls)

	n = sz / 5
	speedtest1_begin_test(tls, 160, ts+3998 /* "%d SELECTS, nume..." */, libc.VaList(bp+240, n))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_prepare(tls,

		ts+4035 /* "SELECT count(*),..." */, libc.VaList(bp+248, n))
	for i = 1; i <= n; i++ {
		if (i-1)%g.nRepeat == 0 {
			x1 = speedtest1_random(tls) % uint32(maxb)
			x2 = speedtest1_random(tls)%uint32(10) + uint32(sz/5000) + x1
	...
	n = sz / 5
	speedtest1_begin_test(tls, 161, ts+4140 /* "%d SELECTS, nume..." */, libc.VaList(bp+256, n))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_prepare(tls,

		ts+4172 /* "SELECT count(*),..." */, libc.VaList(bp+264, n))
	for i = 1; i <= n; i++ {
		if (i-1)%g.nRepeat == 0 {
			x1 = speedtest1_random(tls) % uint32(maxb)
			x2 = speedtest1_random(tls)%uint32(10) + uint32(sz/5000) + x1
	...
	n = sz / 5
	speedtest1_begin_test(tls, 170, ts+4277 /* "%d SELECTS, text..." */, libc.VaList(bp+272, n))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_prepare(tls,

		ts+4311 /* "SELECT count(*),..." */, libc.VaList(bp+280, n))
	for i = 1; i <= n; i++ {
		if (i-1)%g.nRepeat == 0 {
			x1 = swizzle(tls, uint32(i), uint32(maxb))
			len = speedtest1_numbername(tls, x1, bp+568 /* &zNum[0] */, int32(uint32(unsafe.Sizeof([2000]uint8{}))-uint32(1)))
		}
	...
	n = sz
	speedtest1_begin_test(tls, 180, ts+4423 /* "%d INSERTS with ..." */, libc.VaList(bp+288, n))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_exec(tls,

		ts+4453, /* "CREATE%s TABLE t..." */
		libc.VaList(bp+296, isTemp(tls, 1), g.zNN, g.zPK, g.zNN, g.zNN, g.zWR))
	speedtest1_exec(tls, ts+4524 /* "CREATE INDEX t4b..." */, 0)
	speedtest1_exec(tls, ts+4550 /* "CREATE INDEX t4c..." */, 0)
	speedtest1_exec(tls, ts+4576 /* "INSERT INTO t4 S..." */, 0)
	speedtest1_exec(tls, ts+3023 /* "COMMIT" */, 0)
	speedtest1_end_test(tls)

	n = sz
	speedtest1_begin_test(tls, 190, ts+4608 /* "DELETE and REFIL..." */, libc.VaList(bp+344, n))
	speedtest1_exec(tls, ts+4636 /* "DELETE FROM z2;" */, 0)
	speedtest1_exec(tls, ts+4652 /* "INSERT INTO z2 S..." */, 0)
	speedtest1_end_test(tls)

	speedtest1_begin_test(tls, 200, ts+4685 /* "VACUUM" */, 0)
	speedtest1_exec(tls, ts+4685 /* "VACUUM" */, 0)
	speedtest1_end_test(tls)

	speedtest1_begin_test(tls, 210, ts+4692 /* "ALTER TABLE ADD ..." */, 0)
	speedtest1_exec(tls, ts+4726 /* "ALTER TABLE z2 A..." */, 0)
	speedtest1_exec(tls, ts+4770 /* "SELECT sum(d) FR..." */, 0)
	speedtest1_end_test(tls)

	n = sz / 5
	speedtest1_begin_test(tls, 230, ts+4792 /* "%d UPDATES, nume..." */, libc.VaList(bp+352, n))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_prepare(tls,
		ts+4829 /* "UPDATE z2 SET d=..." */, libc.VaList(bp+360, n))
	for i = 1; i <= n; i++ {
		x1 = speedtest1_random(tls) % uint32(maxb)
		x2 = speedtest1_random(tls)%uint32(10) + uint32(sz/5000) + x1
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 1, int32(x1))
	...
	n = sz
	speedtest1_begin_test(tls, 240, ts+4888 /* "%d UPDATES of in..." */, libc.VaList(bp+368, n))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_prepare(tls,
		ts+4918 /* "UPDATE z2 SET d=..." */, libc.VaList(bp+376, n))
	for i = 1; i <= n; i++ {
	...
	speedtest1_begin_test(tls, 250, ts+4962 /* "One big UPDATE o..." */, libc.VaList(bp+384, sz))
	speedtest1_exec(tls, ts+5003 /* "UPDATE z2 SET d=..." */, 0)
	speedtest1_end_test(tls)

	speedtest1_begin_test(tls, 260, ts+5023 /* "Query added colu..." */, 0)
	speedtest1_exec(tls, ts+4770 /* "SELECT sum(d) FR..." */, 0)
	speedtest1_end_test(tls)

	n = sz / 5
	speedtest1_begin_test(tls, 270, ts+5056 /* "%d DELETEs, nume..." */, libc.VaList(bp+392, n))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_prepare(tls,
		ts+5093 /* "DELETE FROM z2 W..." */, libc.VaList(bp+400, n))
	for i = 1; i <= n; i++ {
	...
	n = sz
	speedtest1_begin_test(tls, 280, ts+5147 /* "%d DELETEs of in..." */, libc.VaList(bp+408, n))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_prepare(tls,
		ts+5177 /* "DELETE FROM t3 W..." */, libc.VaList(bp+416, n))
	for i = 1; i <= n; i++ {
		x1 = speedtest1_random(tls)%uint32(sz) + uint32(1)
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 1, int32(x1))
		speedtest1_run(tls)
	...
	speedtest1_begin_test(tls, 290, ts+5216 /* "Refill two %d-ro..." */, libc.VaList(bp+424, sz))
	speedtest1_exec(tls, ts+5255 /* "REPLACE INTO z2(..." */, 0)
	speedtest1_exec(tls, ts+5299 /* "REPLACE INTO t3(..." */, 0)
	speedtest1_end_test(tls)

	speedtest1_begin_test(tls, 300, ts+5343 /* "Refill a %d-row ..." */, libc.VaList(bp+432, sz))
	speedtest1_exec(tls, ts+4636 /* "DELETE FROM z2;" */, 0)
	speedtest1_exec(tls,
		ts+5384 /* "INSERT INTO z2(a..." */, 0)
	speedtest1_exec(tls,
		ts+5449 /* "INSERT INTO z2(a..." */, 0)
	speedtest1_end_test(tls)

	n = sz / 5
	speedtest1_begin_test(tls, 310, ts+5514 /* "%d four-ways joi..." */, libc.VaList(bp+440, n))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_prepare(tls,

		ts+5533 /* "SELECT z1.c FROM..." */, 0)
	for i = 1; i <= n; i++ {
		x1 = speedtest1_random(tls)%uint32(sz) + uint32(1)
	...
	speedtest1_begin_test(tls, 320, ts+5646 /* "subquery in resu..." */, libc.VaList(bp+448, n))
	speedtest1_prepare(tls,

		ts+5669 /* "SELECT sum(a), m..." */, 0)
	...
	*(*uint8)(unsafe.Pointer(bp + 568 /* &zNum[0] */)) = uint8(0)
	...
	speedtest1_begin_test(tls, 400, ts+5787 /* "%d REPLACE ops o..." */, libc.VaList(bp+456, n))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_exec(tls, ts+5812, /* "CREATE%s TABLE t..." */
		libc.VaList(bp+464, isTemp(tls, 9), g.zNN))
	speedtest1_prepare(tls, ts+5860 /* "REPLACE INTO t5 ..." */, libc.VaList(bp+480, n))
	for i = 1; i <= n; i++ {
		x1 = swizzle(tls, uint32(i), uint32(maxb))
	...
	speedtest1_exec(tls, ts+3023 /* "COMMIT" */, 0)
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, 410, ts+5904 /* "%d SELECTS on an..." */, libc.VaList(bp+488, n))
	speedtest1_prepare(tls, ts+5925 /* "SELECT b FROM t5..." */, libc.VaList(bp+496, n))
	for i = 1; i <= n; i++ {
		x1 = swizzle(tls, uint32(i), uint32(maxb))
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 1, int32(sqlite3_int64(x1)))
		speedtest1_run(tls)
	...
	*(*uint8)(unsafe.Pointer(bp + 568 /* &zNum[0] */)) = uint8(0)
	maxb = int32(roundup_allones(tls, uint32(sz/3)))
	speedtest1_begin_test(tls, 500, ts+5967 /* "%d REPLACE on TE..." */, libc.VaList(bp+504, n))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_exec(tls, ts+5989, /* "CREATE%s TABLE t..." */
	...
	speedtest1_prepare(tls, ts+6050 /* "REPLACE INTO t6 ..." */, libc.VaList(bp+536, n))
	for i = 1; i <= n; i++ {
		x1 = swizzle(tls, uint32(i), uint32(maxb))
		speedtest1_numbername(tls, x1, bp+568 /* &zNum[0] */, int32(unsafe.Sizeof([2000]uint8{})))
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 2, i)
	...
	speedtest1_exec(tls, ts+3023 /* "COMMIT" */, 0)
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, 510, ts+6094 /* "%d SELECTS on a ..." */, libc.VaList(bp+544, n))
	speedtest1_prepare(tls, ts+6118 /* "SELECT b FROM t6..." */, libc.VaList(bp+552, n))
	for i = 1; i <= n; i++ {
		x1 = swizzle(tls, uint32(i), uint32(maxb))
		speedtest1_numbername(tls, x1, bp+568 /* &zNum[0] */, int32(unsafe.Sizeof([2000]uint8{})))
		sqlite3.Xsqlite3_bind_text(tls, g.pStmt, 1, bp+568 /* &zNum[0] */, -1, uintptr(0))
	...
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, 520, ts+6160 /* "%d SELECT DISTIN..." */, libc.VaList(bp+560, n))
	speedtest1_exec(tls, ts+6179 /* "SELECT DISTINCT ..." */, 0)
	speedtest1_exec(tls, ts+6206 /* "SELECT DISTINCT ..." */, 0)
	speedtest1_end_test(tls)

	speedtest1_begin_test(tls, 980, ts+6233 /* "PRAGMA integrity..." */, 0)
	speedtest1_exec(tls, ts+6233 /* "PRAGMA integrity..." */, 0)
	speedtest1_end_test(tls)

	speedtest1_begin_test(tls, 990, ts+6256 /* "ANALYZE" */, 0)
	speedtest1_exec(tls, ts+6256 /* "ANALYZE" */, 0)
	speedtest1_end_test(tls)
}

// A testset for common table expressions.  This exercises code
// for views, subqueries, co-routines, etc.
func testset_cte(tls *libc.TLS) { /* speedtest1.c:1147:6: */
	bp := tls.Alloc(32)
	defer tls.Free(32)
	...
	speedtest1_begin_test(tls, 100, ts+6264 /* "Sudoku with recu..." */, 0)
	speedtest1_prepare(tls,

		ts+6295 /* "WITH RECURSIVE\n ..." */, 0)
	sqlite3.Xsqlite3_bind_text(tls, g.pStmt, 1, zPuz, -1, uintptr(0))
	speedtest1_run(tls)
	speedtest1_end_test(tls)

	speedtest1_begin_test(tls, 200, ts+7099 /* "Sudoku with VALU..." */, 0)
	speedtest1_prepare(tls,

		ts+7127 /* "WITH RECURSIVE\n ..." */, 0)
	sqlite3.Xsqlite3_bind_text(tls, g.pStmt, 1, zPuz, -1, uintptr(0))
	speedtest1_run(tls)
	speedtest1_end_test(tls)

	rSpacing = 5.0 / float64(g.szTest)
	speedtest1_begin_test(tls, 300, ts+7939 /* "Mandelbrot Set w..." */, libc.VaList(bp, rSpacing))
	speedtest1_prepare(tls,

		ts+7970 /* "WITH RECURSIVE \n..." */, 0)
	...
	speedtest1_begin_test(tls, 400, ts+8566 /* "EXCEPT operator ..." */, libc.VaList(bp+8, nElem))
	speedtest1_prepare(tls,

		ts+8603, /* "WITH RECURSIVE \n..." */
...
var azPuzzle = [3]uintptr{
	...
	ts + 8998, /* "53.......6..195...." */
} /* speedtest1.c:1148:21 */

// Compute a pseudo-random floating point ascii number.
func speedtest1_random_ascii_fp(tls *libc.TLS, zFP uintptr) { /* speedtest1.c:1300:6: */
	bp := tls.Alloc(24)
	defer tls.Free(24)
	...
	y = y / 10
	sqlite3.Xsqlite3_snprintf(tls, 100, zFP, ts+9080 /* "%d.%de%d" */, libc.VaList(bp, y, z, x%200))
}

// A testset for floating-point numbers.
func testset_fp(tls *libc.TLS) { /* speedtest1.c:1313:6: */
	bp := tls.Alloc(272)
	defer tls.Free(272)
	...
	n = g.szTest * 5000
	speedtest1_begin_test(tls, 100, ts+9089 /* "Fill a table wit..." */, libc.VaList(bp, n*2))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_exec(tls, ts+9120, /* "CREATE%s TABLE z..." */
		libc.VaList(bp+8, isTemp(tls, 1), g.zNN, g.zNN))
	speedtest1_prepare(tls, ts+9161 /* "INSERT INTO z1 V..." */, libc.VaList(bp+32, n))
	for i = 1; i <= n; i++ {
	...
	n = g.szTest/25 + 2
	speedtest1_begin_test(tls, 110, ts+9203 /* "%d range queries" */, libc.VaList(bp+40, n))
	speedtest1_prepare(tls, ts+9220 /* "SELECT sum(b) FR..." */, 0)
	for i = 1; i <= n; i++ {
		speedtest1_random_ascii_fp(tls, bp+72 /* &zFP1[0] */)
		speedtest1_random_ascii_fp(tls, bp+172 /* &zFP2[0] */)
		sqlite3.Xsqlite3_bind_text(tls, g.pStmt, 1, bp+72 /* &zFP1[0] */, -1, uintptr(0))
	...
	speedtest1_begin_test(tls, 120, ts+9268 /* "CREATE INDEX thr..." */, 0)
	speedtest1_exec(tls, ts+3826 /* "BEGIN;" */, 0)
	speedtest1_exec(tls, ts+9293 /* "CREATE INDEX t1a..." */, 0)
	speedtest1_exec(tls, ts+9320 /* "CREATE INDEX t1b..." */, 0)
	speedtest1_exec(tls, ts+9347 /* "CREATE INDEX t1a..." */, 0)
	speedtest1_exec(tls, ts+3990 /* "COMMIT;" */, 0)
	speedtest1_end_test(tls)

	n = g.szTest/3 + 2
	speedtest1_begin_test(tls, 130, ts+9377 /* "%d indexed range..." */, libc.VaList(bp+48, n))
	speedtest1_prepare(tls, ts+9220 /* "SELECT sum(b) FR..." */, 0)
	for i = 1; i <= n; i++ {
		speedtest1_random_ascii_fp(tls, bp+72 /* &zFP1[0] */)
		speedtest1_random_ascii_fp(tls, bp+172 /* &zFP2[0] */)
	...
	n = g.szTest * 5000
	speedtest1_begin_test(tls, 140, ts+9402 /* "%d calls to roun..." */, libc.VaList(bp+56, n))
	speedtest1_exec(tls, ts+9422 /* "SELECT sum(round..." */, 0)
	speedtest1_end_test(tls)

	speedtest1_begin_test(tls, 150, ts+9465 /* "%d printf() call..." */, libc.VaList(bp+64, n*4))
	speedtest1_exec(tls,

		ts+9483 /* "WITH c(fmt) AS (..." */, 0)
	speedtest1_end_test(tls)
}
...
// be far apart.
func twoCoords(tls *libc.TLS, p1 int32, p2 int32, mx uint32, pX0 uintptr, pX1 uintptr) { /* speedtest1.c:1386:13: */
	var d uint32
	var x0 uint32
	var x1 uint32
	var span uint32
...
func xsliceGeometryCallback(tls *libc.TLS, p uintptr, nCoord int32, aCoord uintptr, pRes uintptr) int32 { /* speedtest1.c:1415:12: */
...
func testset_rtree(tls *libc.TLS, p1 int32, p2 int32) { /* speedtest1.c:1430:6: */
	bp := tls.Alloc(224)
	defer tls.Free(224)
	...
	speedtest1_begin_test(tls, 100, ts+9578 /* "%d INSERTs into ..." */, libc.VaList(bp, n))
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_exec(tls, ts+9604 /* "CREATE VIRTUAL T..." */, 0)
	speedtest1_prepare(tls,
		ts+9663 /* "INSERT INTO rt1(..." */, 0)
	...
	speedtest1_begin_test(tls, 101, ts+9729 /* "Copy from rtree ..." */, 0)
	speedtest1_exec(tls, ts+9764 /* "CREATE TABLE z1(..." */, 0)
	speedtest1_exec(tls, ts+9822 /* "INSERT INTO z1 S..." */, 0)
	speedtest1_end_test(tls)

	n = uint32(g.szTest * 200)
	speedtest1_begin_test(tls, 110, ts+9855 /* "%d one-dimension..." */, libc.VaList(bp+8, n))
	speedtest1_prepare(tls, ts+9898 /* "SELECT count(*) ..." */, 0)
	iStep = mxCoord / n
	for i = uint32(0); i < n; i++ {
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 1, int32(i*iStep))
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 2, int32((i+uint32(1))*iStep))
		speedtest1_run(tls)
		*(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) = libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+100)
	}
	speedtest1_end_test(tls)

	if g.bVerify != 0 {
		n = uint32(g.szTest * 200)
		speedtest1_begin_test(tls, 111, ts+9947 /* "Verify result fr..." */, 0)
		speedtest1_prepare(tls, ts+9994 /* "SELECT count(*) ..." */, 0)
		iStep = mxCoord / n
		for i = uint32(0); i < n; i++ {
			sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 1, int32(i*iStep))
			sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 2, int32((i+uint32(1))*iStep))
			speedtest1_run(tls)
			if *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+100) {
				fatal_error(tls, ts+10042, /* "Count disagree s..." */
					libc.VaList(bp+16, i, i*iStep, (i+uint32(1))*iStep, *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+100)))
			}
		}
		speedtest1_end_test(tls)
	}
	...
	n = uint32(g.szTest * 200)
	speedtest1_begin_test(tls, 120, ts+10084 /* "%d one-dimension..." */, libc.VaList(bp+56, n))
	speedtest1_prepare(tls, ts+10125 /* "SELECT count(*) ..." */, 0)
	iStep = mxCoord / n
	for i = uint32(0); i < n; i++ {
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 1, int32(i*iStep))
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 2, int32((i+uint32(1))*iStep))
	...
	if g.bVerify != 0 {
		n = uint32(g.szTest * 200)
		speedtest1_begin_test(tls, 121, ts+10174 /* "Verify result fr..." */, 0)
		speedtest1_prepare(tls, ts+10219 /* "SELECT count(*) ..." */, 0)
		iStep = mxCoord / n
		for i = uint32(0); i < n; i++ {
			sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 1, int32(i*iStep))
			sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 2, int32((i+uint32(1))*iStep))
			...
			if *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+100) {
				fatal_error(tls, ts+10042, /* "Count disagree s..." */
					libc.VaList(bp+64, i, i*iStep, (i+uint32(1))*iStep, *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+100)))
			}
		}
		speedtest1_end_test(tls)
	}
	...
	n = uint32(g.szTest * 200)
	speedtest1_begin_test(tls, 125, ts+10267 /* "%d custom geomet..." */, libc.VaList(bp+104, n))
	sqlite3.Xsqlite3_rtree_geometry_callback(tls, g.db, ts+10303 /* "xslice" */, *(*uintptr)(unsafe.Pointer(&struct {
		f func(*libc.TLS, uintptr, int32, uintptr, uintptr) int32
	}{xsliceGeometryCallback})), uintptr(0))
	speedtest1_prepare(tls, ts+10310 /* "SELECT count(*) ..." */, 0)
	iStep = mxCoord / n
	for i = uint32(0); i < n; i++ {
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 1, int32(i*iStep))
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 2, int32((i+uint32(1))*iStep))
		...
		if *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+100) {
			fatal_error(tls, ts+10042, /* "Count disagree s..." */
				libc.VaList(bp+112, i, i*iStep, (i+uint32(1))*iStep, *(*int32)(unsafe.Pointer(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+100)))
		}
	}
	speedtest1_end_test(tls)

	n = uint32(g.szTest * 400)
	speedtest1_begin_test(tls, 130, ts+10364 /* "%d three-dimensi..." */, libc.VaList(bp+152, n))
	speedtest1_prepare(tls,
		ts+10407 /* "SELECT count(*) ..." */, 0)
	iStep = mxCoord / n
	for i = uint32(0); i < n; i++ {
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 1, int32(i*iStep))
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 2, int32((i+uint32(1))*iStep))
	...
	speedtest1_begin_test(tls, 140, ts+10500 /* "%d rowid queries" */, libc.VaList(bp+160, n))
	speedtest1_prepare(tls, ts+10517 /* "SELECT * FROM rt..." */, 0)
	for i = uint32(1); i <= n; i++ {
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 1, int32(i))
		speedtest1_run(tls)
	}
	...
	speedtest1_begin_test(tls, 150, ts+10547 /* "%d UPDATEs using..." */, libc.VaList(bp+168, n))
	speedtest1_prepare(tls, ts+10570 /* "UPDATE rt1 SET x..." */, 0)
	for i = uint32(1); i <= n; i++ {
	...
	n = uint32(g.szTest * 5)
	speedtest1_begin_test(tls, 155, ts+10618 /* "%d UPDATEs using..." */, libc.VaList(bp+176, n))
	speedtest1_prepare(tls,
		ts+10659 /* "UPDATE rt1 SET x..." */, 0)
	iStep = mxCoord / n
	for i = uint32(0); i < n; i++ {
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 1, int32(i*iStep))
		speedtest1_run(tls)
	...
	n = uint32(g.szTest * 50)
	speedtest1_begin_test(tls, 160, ts+10721 /* "%d DELETEs using..." */, libc.VaList(bp+184, n))
	speedtest1_prepare(tls, ts+10744 /* "DELETE FROM rt1 ..." */, 0)
	for i = uint32(1); i <= n; i++ {
	...
	n = uint32(g.szTest * 5)
	speedtest1_begin_test(tls, 165, ts+10772 /* "%d DELETEs using..." */, libc.VaList(bp+192, n))
	speedtest1_prepare(tls, ts+10813 /* "DELETE FROM rt1 ..." */, 0)
	iStep = mxCoord / n
	for i = uint32(0); i < n; i++ {
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 1, int32(i*iStep))
		speedtest1_run(tls)
	...
	speedtest1_begin_test(tls, 170, ts+10855 /* "Restore deleted ..." */, 0)
	speedtest1_exec(tls, ts+10902 /* "INSERT OR IGNORE..." */, 0)
	speedtest1_end_test(tls)
}
...
func testset_orm(tls *libc.TLS) { /* speedtest1.c:1615:6: */
	bp := tls.Alloc(2016)
	defer tls.Free(2016)
	...
	speedtest1_begin_test(tls, 100, ts+10945 /* "Fill %d rows" */, libc.VaList(bp, n))
	speedtest1_exec(tls,

		ts+10958 /* "BEGIN;CREATE TAB..." */, 0)
	speedtest1_prepare(tls,

		ts+14858 /* "INSERT INTO ZLOO..." */, 0)
	for i = uint32(0); i < n; i++ {
	...
	speedtest1_begin_test(tls, 110, ts+18102 /* "Query %d rows by..." */, libc.VaList(bp+8, n))
	speedtest1_prepare(tls,

		ts+18125 /* "SELECT ZCYANBASE..." */, 0)
	for i = uint32(0); i < n; i++ {
...
*(*[120]uint8)(unsafe.Pointer(ts + 20878 /* "IBBIIITIVVITBTBF..." */)) /* speedtest1.c:1620:21 */

//
func testset_trigger(tls *libc.TLS) { /* speedtest1.c:1882:6: */
	bp := tls.Alloc(2032)
	defer tls.Free(2032)
	...
	speedtest1_exec(tls,
		...
		ts+20998 /* "BEGIN;CREATE TAB..." */, 0)
	for jj = 1; jj <= 3; jj++ {
		speedtest1_prepare(tls, ts+21326 /* "INSERT INTO t%d ..." */, libc.VaList(bp, jj))
		for ii = 0; ii < NROW; ii++ {
	...
	speedtest1_exec(tls,
		...
		ts+21361 /* "CREATE INDEX i1 ..." */, 0)

	speedtest1_begin_test(tls, 100, ts+21444 /* "speed4p-join1" */, 0)
	speedtest1_prepare(tls,
		ts+21458 /* "SELECT * FROM z1..." */, 0)
	speedtest1_run(tls)
	speedtest1_end_test(tls)

	speedtest1_begin_test(tls, 110, ts+21525 /* "speed4p-join2" */, 0)
	speedtest1_prepare(tls,
		ts+21539 /* "SELECT * FROM z1..." */, 0)
	speedtest1_run(tls)
	speedtest1_end_test(tls)

	speedtest1_begin_test(tls, 120, ts+21598 /* "speed4p-view1" */, 0)
	for jj = 1; jj <= 3; jj++ {
		speedtest1_prepare(tls, ts+21612 /* "SELECT * FROM v%..." */, libc.VaList(bp+8, jj))
	...
	speedtest1_begin_test(tls, 130, ts+21646 /* "speed4p-table1" */, 0)
	for jj = 1; jj <= 3; jj++ {
		speedtest1_prepare(tls, ts+21661 /* "SELECT * FROM t%..." */, libc.VaList(bp+16, jj))
		for ii = 0; ii < NROW2; ii = ii + 3 {
			sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 1, ii*3)
			speedtest1_run(tls)
		}
	...
	speedtest1_begin_test(tls, 140, ts+21646 /* "speed4p-table1" */, 0)
	for jj = 1; jj <= 3; jj++ {
		speedtest1_prepare(tls, ts+21661 /* "SELECT * FROM t%..." */, libc.VaList(bp+24, jj))
		for ii = 0; ii < NROW2; ii = ii + 3 {
			sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 1, ii*3)
			speedtest1_run(tls)
		}
	...
	speedtest1_begin_test(tls, 150, ts+21695 /* "speed4p-subselec..." */, 0)
	speedtest1_prepare(tls,

		ts+21714 /* "SELECT (SELECT t..." */, 0)
	...
	speedtest1_begin_test(tls, 160, ts+21829 /* "speed4p-rowid-up..." */, 0)
	speedtest1_exec(tls, ts+2913 /* "BEGIN" */, 0)
	speedtest1_prepare(tls, ts+21850 /* "UPDATE z1 SET i=..." */, 0)
	for jj = 0; jj < NROW2; jj++ {
	...
	speedtest1_exec(tls, ts+21885 /* "CREATE TABLE t5(..." */, 0)
	speedtest1_begin_test(tls, 170, ts+21933 /* "speed4p-insert-i..." */, 0)
	speedtest1_exec(tls, ts+21955 /* "INSERT OR IGNORE..." */, 0)
	speedtest1_end_test(tls)

	speedtest1_exec(tls,

		ts+22000 /* "CREATE TABLE log..." */, 0)

	speedtest1_begin_test(tls, 180, ts+22490 /* "speed4p-trigger1" */, 0)
	speedtest1_prepare(tls, ts+22507 /* "INSERT INTO t4 V..." */, 0)
	for jj = 0; jj < NROW2; jj++ {
	...
	// inadvertantly.
	speedtest1_begin_test(tls, 190, ts+22543 /* "speed4p-trigger2" */, 0)
	speedtest1_prepare(tls, ts+22560 /* "UPDATE t4 SET i ..." */, 0)
	...
	// Note: Same again.
	speedtest1_begin_test(tls, 200, ts+22606 /* "speed4p-trigger3" */, 0)
	speedtest1_prepare(tls, ts+22623 /* "DELETE FROM t4 W..." */, 0)
	for jj = 1; jj <= NROW2*2; jj = jj + 2 {
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 1, jj*2)
		speedtest1_run(tls)
	}
	...
	speedtest1_exec(tls,
		...
		ts+22655 /* "DROP TABLE t4;DR..." */, 0)
	speedtest1_begin_test(tls, 210, ts+22760 /* "speed4p-notrigge..." */, 0)
	speedtest1_prepare(tls, ts+22507 /* "INSERT INTO t4 V..." */, 0)
	for jj = 0; jj < NROW2; jj++ {
		speedtest1_numbername(tls, uint32(jj), bp+32 /* &zNum[0] */, int32(unsafe.Sizeof([2000]uint8{})))
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 1, jj)
	...
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, 210, ts+22779 /* "speed4p-notrigge..." */, 0)
	speedtest1_prepare(tls, ts+22560 /* "UPDATE t4 SET i ..." */, 0)
	for jj = 1; jj <= NROW2*2; jj = jj + 2 {
		speedtest1_numbername(tls, uint32(jj*2), bp+32 /* &zNum[0] */, int32(unsafe.Sizeof([2000]uint8{})))
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 1, jj*2)
	...
	speedtest1_end_test(tls)
	speedtest1_begin_test(tls, 220, ts+22798 /* "speed4p-notrigge..." */, 0)
	speedtest1_prepare(tls, ts+22623 /* "DELETE FROM t4 W..." */, 0)
	for jj = 1; jj <= NROW2*2; jj = jj + 2 {
		sqlite3.Xsqlite3_bind_int(tls, g.pStmt, 1, jj*2)
		speedtest1_run(tls)
...
func testset_debug1(tls *libc.TLS) { /* speedtest1.c:2084:6: */
	bp := tls.Alloc(2032)
	defer tls.Free(2032)
	...
	for i = uint32(1); i <= n; i++ {
		...
		libc.Xprintf(tls, ts+22817 /* "%5d %5d %5d %s\n" */, libc.VaList(bp, i, x1, x2, bp+32 /* &zNum[0] */))
	}
}
...
func displayLinuxIoStats(tls *libc.TLS, out uintptr) { /* speedtest1.c:2105:13: */
	bp := tls.Alloc(224)
	defer tls.Free(224)
	...
	sqlite3.Xsqlite3_snprintf(tls, int32(unsafe.Sizeof([200]uint8{})), bp+24 /* &z[0] */, ts+22833 /* "/proc/%d/io" */, libc.VaList(bp, libc.Xgetpid(tls)))
	in = libc.Xfopen(tls, bp+24 /* &z[0] */, ts+22845 /* "rb" */)
	if in == uintptr(0) {
		return
	}
	for libc.Xfgets(tls, bp+24, int32(unsafe.Sizeof([200]uint8{})), in) != uintptr(0) {
		...
		for i = 0; uint32(i) < uint32(unsafe.Sizeof(aTrans))/uint32(unsafe.Sizeof(struct {
			...
			if libc.Xstrncmp(tls, aTrans[i].zPattern, bp+24, uint32(n)) == 0 {
				libc.Xfprintf(tls, out, ts+22848 /* "-- %-28s %s" */, libc.VaList(bp+8, aTrans[i].zDesc, bp+24+uintptr(n)))
				break
			}
		}
	}
...
var aTrans = [7]struct {
	...
	{zPattern: ts + 22860 /* "rchar: " */, zDesc: ts + 22868 /* "Bytes received b..." */},
	{zPattern: ts + 22894 /* "wchar: " */, zDesc: ts + 22902 /* "Bytes sent to wr..." */},
	{zPattern: ts + 22925 /* "syscr: " */, zDesc: ts + 22933 /* "Read() system ca..." */},
	{zPattern: ts + 22954 /* "syscw: " */, zDesc: ts + 22962 /* "Write() system c..." */},
	{zPattern: ts + 22984 /* "read_bytes: " */, zDesc: ts + 22997 /* "Bytes rcvd from ..." */},
	{zPattern: ts + 23022 /* "write_bytes: " */, zDesc: ts + 23036 /* "Bytes sent to st..." */},
	{zPattern: ts + 23059 /* "cancelled_write_..." */, zDesc: ts + 23083 /* "Cancelled write ..." */},
} /* speedtest1.c:2115:7 */

func xCompileOptions(tls *libc.TLS, pCtx uintptr, nVal int32, azVal uintptr, azCol uintptr) int32 { /* speedtest1.c:2145:12: */
	bp := tls.Alloc(8)
	defer tls.Free(8)

	libc.Xprintf(tls, ts+23106 /* "-- Compile optio..." */, libc.VaList(bp, *(*uintptr)(unsafe.Pointer(azVal))))
	return SQLITE_OK
}

func main1(tls *libc.TLS, argc int32, argv uintptr) int32 { /* speedtest1.c:2150:5: */
	bp := tls.Alloc(576)
	defer tls.Free(576)
	...
	var zTSet uintptr = ts + 23129     /* "main" */ // Which --testset torun
	...
	for i = 1; i < argc; i++ {
		...
		if int32(*(*uint8)(unsafe.Pointer(z))) == '-' {
			...
			if libc.Xstrcmp(tls, z, ts+23176) == 0 {
				doAutovac = 1
			} else if libc.Xstrcmp(tls, z, ts+23187) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23197 /* "missing argument..." */, libc.VaList(bp+16, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				i++
				cacheSize = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)))
			} else if libc.Xstrcmp(tls, z, ts+23221) == 0 {
				doExclusive = 1
			} else if libc.Xstrcmp(tls, z, ts+23231) == 0 {
				g.doCheckpoint = 1
			} else if libc.Xstrcmp(tls, z, ts+23242) == 0 {
				g.bSqlOnly = 1
				g.bExplain = 1
			} else if libc.Xstrcmp(tls, z, ts+23250) == 0 {
				if i >= argc-2 {
					fatal_error(tls, ts+23255 /* "missing argument..." */, libc.VaList(bp+24, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				i = i + 2
			} else if libc.Xstrcmp(tls, z, ts+23280) == 0 {
				doIncrvac = 1
			} else if libc.Xstrcmp(tls, z, ts+23291) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23197 /* "missing argument..." */, libc.VaList(bp+32, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				zJMode = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4))
			} else if libc.Xstrcmp(tls, z, ts+23299) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23197 /* "missing argument..." */, libc.VaList(bp+40, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				zKey = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4))
			} else if libc.Xstrcmp(tls, z, ts+23303) == 0 {
				if i >= argc-2 {
					fatal_error(tls, ts+23255 /* "missing argument..." */, libc.VaList(bp+48, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				i = i + 2
			} else if libc.Xstrcmp(tls, z, ts+23313) == 0 {
				memDb = 1
			} else if libc.Xstrcmp(tls, z, ts+23319) == 0 {
				sqlite3.Xsqlite3_config(tls, SQLITE_CONFIG_MULTITHREAD, 0)
			} else if libc.Xstrcmp(tls, z, ts+23331) == 0 {
				sqlite3.Xsqlite3_config(tls, SQLITE_CONFIG_MEMSTATUS, libc.VaList(bp+56, 0))
			} else if libc.Xstrcmp(tls, z, ts+23341) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23197 /* "missing argument..." */, libc.VaList(bp+64, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				mmapSize = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4)))
			} else if libc.Xstrcmp(tls, z, ts+23346) == 0 {
				noSync = 1
			} else if libc.Xstrcmp(tls, z, ts+23353) == 0 {
				g.zNN = ts + 23361 /* "NOT NULL" */
			} else if libc.Xstrcmp(tls, z, ts+23370) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23197 /* "missing argument..." */, libc.VaList(bp+72, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				i++
				if libc.Xstrcmp(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), ts+23377) == 0 {
					g.hashFile = libc.Xstdout
				} else {
					g.hashFile = libc.Xfopen(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), ts+23379 /* "wb" */)
					if g.hashFile == uintptr(0) {
						fatal_error(tls, ts+23382 /* "cannot open \"%s\"..." */, libc.VaList(bp+80, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
					}
				}
			} else if libc.Xstrcmp(tls, z, ts+23412) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23197 /* "missing argument..." */, libc.VaList(bp+88, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				pageSize = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4)))
			} else if libc.Xstrcmp(tls, z, ts+23421) == 0 {
				if i >= argc-2 {
					fatal_error(tls, ts+23255 /* "missing argument..." */, libc.VaList(bp+96, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				...
				doPCache = 1
				i = i + 2
			} else if libc.Xstrcmp(tls, z, ts+23428) == 0 {
				g.zPK = ts + 23439 /* "PRIMARY KEY" */
			} else if libc.Xstrcmp(tls, z, ts+23451) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23255 /* "missing argument..." */, libc.VaList(bp+104, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				g.nRepeat = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(i+1)*4)))
				i = i + 1
			} else if libc.Xstrcmp(tls, z, ts+23458) == 0 {
				g.bReprepare = 1
			} else if libc.Xstrcmp(tls, z, ts+23468) == 0 {
				sqlite3.Xsqlite3_config(tls, SQLITE_CONFIG_SERIALIZED, 0)
			} else if libc.Xstrcmp(tls, z, ts+23479) == 0 {
				sqlite3.Xsqlite3_config(tls, SQLITE_CONFIG_SINGLETHREAD, 0)
			} else if libc.Xstrcmp(tls, z, ts+23492) == 0 {
				g.bSqlOnly = 1
			} else if libc.Xstrcmp(tls, z, ts+23500) == 0 {
				g.bMemShrink = 1
			} else if libc.Xstrcmp(tls, z, ts+23514) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23197 /* "missing argument..." */, libc.VaList(bp+112, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				g.szTest = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4)))
			} else if libc.Xstrcmp(tls, z, ts+23519) == 0 {
				showStats = 1
			} else if libc.Xstrcmp(tls, z, ts+23525) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23197 /* "missing argument..." */, libc.VaList(bp+120, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				i++
				if int32(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))) < '0' || int32(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))) > '9' || int32(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)) + 1))) != 0 {
					fatal_error(tls, ts+23530 /* "argument to --te..." */, 0)
				}
				g.eTemp = int32(*(*uint8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))) - '0'
			} else if libc.Xstrcmp(tls, z, ts+23583) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23197 /* "missing argument..." */, libc.VaList(bp+128, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				zTSet = *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4))
			} else if libc.Xstrcmp(tls, z, ts+23591) == 0 {
				doTrace = 1
			} else if libc.Xstrcmp(tls, z, ts+23597) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23197 /* "missing argument..." */, libc.VaList(bp+136, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				nThread = integerValue(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4)))
			} else if libc.Xstrcmp(tls, z, ts+23605) == 0 {
				zEncoding = ts + 23605 /* "utf16le" */
			} else if libc.Xstrcmp(tls, z, ts+23613) == 0 {
				zEncoding = ts + 23613 /* "utf16be" */
			} else if libc.Xstrcmp(tls, z, ts+23621) == 0 {
				g.bVerify = 1
				HashInit(tls)
			} else if libc.Xstrcmp(tls, z, ts+23628) == 0 {
				if i >= argc-1 {
					fatal_error(tls, ts+23197 /* "missing argument..." */, libc.VaList(bp+144, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))))
				}
				g.nReserve = libc.Xatoi(tls, *(*uintptr)(unsafe.Pointer(argv + uintptr(libc.PreIncInt32(&i, 1))*4)))
			} else if libc.Xstrcmp(tls, z, ts+23636) == 0 {
				if libc.Xstrstr(tls, g.zWR, ts+23650) != uintptr(0) {
					// no-op
				} else if libc.Xstrstr(tls, g.zWR, ts+23658) != uintptr(0) {
					g.zWR = ts + 23665 /* "WITHOUT ROWID,ST..." */
				} else {
					g.zWR = ts + 6036 /* "WITHOUT ROWID" */
				}
				g.zPK = ts + 23439 /* "PRIMARY KEY" */
			} else if libc.Xstrcmp(tls, z, ts+23686) == 0 {
				if libc.Xstrstr(tls, g.zWR, ts+23658) != uintptr(0) {
					// no-op
				} else if libc.Xstrstr(tls, g.zWR, ts+23650) != uintptr(0) {
					g.zWR = ts + 23665 /* "WITHOUT ROWID,ST..." */
				} else {
					g.zWR = ts + 23658 /* "STRICT" */
				}
			} else if libc.Xstrcmp(tls, z, ts+23693) == 0 || libc.Xstrcmp(tls, z, ts+23698) == 0 {
				libc.Xprintf(tls, uintptr(unsafe.Pointer(&zHelp)), libc.VaList(bp+152, *(*uintptr)(unsafe.Pointer(argv))))
				libc.Xexit(tls, 0)
			} else {
				fatal_error(tls, ts+23700, /* "unknown option: ..." */
					libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), *(*uintptr)(unsafe.Pointer(argv))))
			}
		} else if zDbName == uintptr(0) {
			zDbName = *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4))
		} else {
			fatal_error(tls, ts+23741, /* "surplus argument..." */
				libc.VaList(bp+176, *(*uintptr)(unsafe.Pointer(argv + uintptr(i)*4)), *(*uintptr)(unsafe.Pointer(argv))))
		}
	}
	...
	if nHeap > 0 {
		...
		if pHeap == uintptr(0) {
			fatal_error(tls, ts+23784 /* "cannot allocate ..." */, libc.VaList(bp+192, nHeap))
		}
		rc = sqlite3.Xsqlite3_config(tls, SQLITE_CONFIG_HEAP, libc.VaList(bp+200, pHeap, nHeap, mnHeap))
		if rc != 0 {
			fatal_error(tls, ts+23814 /* "heap configurati..." */, libc.VaList(bp+224, rc))
		}
	}
	if doPCache != 0 {
		if nPCache > 0 && szPCache > 0 {
			...
			if pPCache == uintptr(0) {
				fatal_error(tls, ts+23845, /* "cannot allocate ..." */
		...
		if rc != 0 {
			fatal_error(tls, ts+23879 /* "pcache configura..." */, libc.VaList(bp+264, rc))
		}
	}
	if nLook >= 0 {
	...
	if sqlite3.Xsqlite3_open(tls, func() uintptr {
		...
		fatal_error(tls, ts+23921 /* "Cannot open data..." */, libc.VaList(bp+288, zDbName))
	}
	if nLook > 0 && szLook > 0 {
		...
		if rc != 0 {
			fatal_error(tls, ts+23952 /* "lookaside config..." */, libc.VaList(bp+320, rc))
		}
	}
	if g.nReserve > 0 {
	...
	sqlite3.Xsqlite3_create_function(tls, g.db, ts+23988 /* "random" */, 0, SQLITE_UTF8, uintptr(0), *(*uintptr)(unsafe.Pointer(&struct {
	...
	if memDb > 0 {
		speedtest1_exec(tls, ts+23995 /* "PRAGMA temp_stor..." */, 0)
	}
	if mmapSize > 0 {
		speedtest1_exec(tls, ts+24020 /* "PRAGMA mmap_size..." */, libc.VaList(bp+328, mmapSize))
	}
	speedtest1_exec(tls, ts+24040 /* "PRAGMA threads=%..." */, libc.VaList(bp+336, nThread))
	if zKey != 0 {
		speedtest1_exec(tls, ts+24058 /* "PRAGMA key('%s')" */, libc.VaList(bp+344, zKey))
	}
	if zEncoding != 0 {
		speedtest1_exec(tls, ts+24075 /* "PRAGMA encoding=..." */, libc.VaList(bp+352, zEncoding))
	}
	if doAutovac != 0 {
		speedtest1_exec(tls, ts+24094 /* "PRAGMA auto_vacu..." */, 0)
	} else if doIncrvac != 0 {
		speedtest1_exec(tls, ts+24118 /* "PRAGMA auto_vacu..." */, 0)
	}
	if pageSize != 0 {
		speedtest1_exec(tls, ts+24149 /* "PRAGMA page_size..." */, libc.VaList(bp+360, pageSize))
	}
	if cacheSize != 0 {
		speedtest1_exec(tls, ts+24169 /* "PRAGMA cache_siz..." */, libc.VaList(bp+368, cacheSize))
	}
	if noSync != 0 {
		speedtest1_exec(tls, ts+24190 /* "PRAGMA synchrono..." */, 0)
	}
	if doExclusive != 0 {
		speedtest1_exec(tls, ts+24213 /* "PRAGMA locking_m..." */, 0)
	}
	if zJMode != 0 {
		speedtest1_exec(tls, ts+24243 /* "PRAGMA journal_m..." */, libc.VaList(bp+376, zJMode))
	}

	if g.bExplain != 0 {
		libc.Xprintf(tls, ts+24266 /* ".explain\n.echo o..." */, 0)
	}
	for ok1 := true; ok1; ok1 = *(*uint8)(unsafe.Pointer(zTSet)) != 0 {
		...
		if g.iTotal > int64(0) || zComma != uintptr(0) {
			libc.Xprintf(tls, ts+24285 /* "       Begin tes..." */, libc.VaList(bp+384, zThisTest))
		}
		if libc.Xstrcmp(tls, zThisTest, ts+23129) == 0 {
			testset_main(tls)
		} else if libc.Xstrcmp(tls, zThisTest, ts+24312) == 0 {
			testset_debug1(tls)
		} else if libc.Xstrcmp(tls, zThisTest, ts+24319) == 0 {
			testset_orm(tls)
		} else if libc.Xstrcmp(tls, zThisTest, ts+24323) == 0 {
			testset_cte(tls)
		} else if libc.Xstrcmp(tls, zThisTest, ts+24327) == 0 {
			testset_fp(tls)
		} else if libc.Xstrcmp(tls, zThisTest, ts+24330) == 0 {
			testset_trigger(tls)
		} else if libc.Xstrcmp(tls, zThisTest, ts+24338) == 0 {
			testset_rtree(tls, 6, 147)
		} else {
			fatal_error(tls,
				ts+24344, /* "unknown testset:..." */
				libc.VaList(bp+392, zThisTest))
		}
		if *(*uint8)(unsafe.Pointer(zTSet)) != 0 {
			var zSql uintptr
			var zObj uintptr
			speedtest1_begin_test(tls, 999, ts+24413 /* "Reset the databa..." */, 0)
			for 1 != 0 {
				zObj = speedtest1_once(tls,

					ts+24432 /* "SELECT name FROM..." */, 0)
				if zObj == uintptr(0) {
					break
				}
				zSql = sqlite3.Xsqlite3_mprintf(tls, ts+24502 /* "DROP TABLE main...." */, libc.VaList(bp+400, zObj))
			...
			for 1 != 0 {
				zObj = speedtest1_once(tls,
					...
					ts+24523 /* "SELECT name FROM..." */, 0)
				if zObj == uintptr(0) {
					break
				}
				zSql = sqlite3.Xsqlite3_mprintf(tls, ts+24502 /* "DROP TABLE main...." */, libc.VaList(bp+408, zObj))
				speedtest1_exec(tls, zSql, 0)
				sqlite3.Xsqlite3_free(tls, zSql)
				sqlite3.Xsqlite3_free(tls, zObj)
			}
	...
	if showStats != 0 {
		sqlite3.Xsqlite3_exec(tls, g.db, ts+24593 /* "PRAGMA compile_o..." */, *(*uintptr)(unsafe.Pointer(&struct {
			f func(*libc.TLS, uintptr, int32, uintptr, uintptr) int32
	...
	if showStats != 0 {
		...
		libc.Xprintf(tls, ts+24616 /* "-- Lookaside Slo..." */, libc.VaList(bp+416, *(*int32)(unsafe.Pointer(bp + 568 /* iCur */)), *(*int32)(unsafe.Pointer(bp + 572 /* iHi */))))
		sqlite3.Xsqlite3_db_status(tls, g.db, SQLITE_DBSTATUS_LOOKASIDE_HIT, bp+568 /* &iCur */, bp+572 /* &iHi */, 0)
		libc.Xprintf(tls, ts+24661 /* "-- Successful lo..." */, libc.VaList(bp+432, *(*int32)(unsafe.Pointer(bp + 572 /* iHi */))))
		sqlite3.Xsqlite3_db_status(tls, g.db, SQLITE_DBSTATUS_LOOKASIDE_MISS_SIZE, bp+568 /* &iCur */, bp+572 /* &iHi */, 0)
		libc.Xprintf(tls, ts+24697 /* "-- Lookaside siz..." */, libc.VaList(bp+440, *(*int32)(unsafe.Pointer(bp + 572 /* iHi */))))
		sqlite3.Xsqlite3_db_status(tls, g.db, SQLITE_DBSTATUS_LOOKASIDE_MISS_FULL, bp+568 /* &iCur */, bp+572 /* &iHi */, 0)
		libc.Xprintf(tls, ts+24733 /* "-- Lookaside OOM..." */, libc.VaList(bp+448, *(*int32)(unsafe.Pointer(bp + 572 /* iHi */))))
		sqlite3.Xsqlite3_db_status(tls, g.db, SQLITE_DBSTATUS_CACHE_USED, bp+568 /* &iCur */, bp+572 /* &iHi */, 0)
		libc.Xprintf(tls, ts+24769 /* "-- Pager Heap Us..." */, libc.VaList(bp+456, *(*int32)(unsafe.Pointer(bp + 568 /* iCur */))))
		sqlite3.Xsqlite3_db_status(tls, g.db, SQLITE_DBSTATUS_CACHE_HIT, bp+568 /* &iCur */, bp+572 /* &iHi */, 1)
		libc.Xprintf(tls, ts+24811 /* "-- Page cache hi..." */, libc.VaList(bp+464, *(*int32)(unsafe.Pointer(bp + 568 /* iCur */))))
		sqlite3.Xsqlite3_db_status(tls, g.db, SQLITE_DBSTATUS_CACHE_MISS, bp+568 /* &iCur */, bp+572 /* &iHi */, 1)
		libc.Xprintf(tls, ts+24847 /* "-- Page cache mi..." */, libc.VaList(bp+472, *(*int32)(unsafe.Pointer(bp + 568 /* iCur */))))
		sqlite3.Xsqlite3_db_status(tls, g.db, SQLITE_DBSTATUS_CACHE_WRITE, bp+568 /* &iCur */, bp+572 /* &iHi */, 1)
		libc.Xprintf(tls, ts+24883 /* "-- Page cache wr..." */, libc.VaList(bp+480, *(*int32)(unsafe.Pointer(bp + 568 /* iCur */))))
		sqlite3.Xsqlite3_db_status(tls, g.db, SQLITE_DBSTATUS_SCHEMA_USED, bp+568 /* &iCur */, bp+572 /* &iHi */, 0)
		libc.Xprintf(tls, ts+24919 /* "-- Schema Heap U..." */, libc.VaList(bp+488, *(*int32)(unsafe.Pointer(bp + 568 /* iCur */))))
		sqlite3.Xsqlite3_db_status(tls, g.db, SQLITE_DBSTATUS_STMT_USED, bp+568 /* &iCur */, bp+572 /* &iHi */, 0)
		libc.Xprintf(tls, ts+24961 /* "-- Statement Hea..." */, libc.VaList(bp+496, *(*int32)(unsafe.Pointer(bp + 568 /* iCur */))))
	}
	...
	if showStats != 0 {
		...
		libc.Xprintf(tls, ts+25003 /* "-- Memory Used (..." */, libc.VaList(bp+504, *(*int32)(unsafe.Pointer(bp + 568 /* iCur */)), *(*int32)(unsafe.Pointer(bp + 572 /* iHi */))))
		sqlite3.Xsqlite3_status(tls, SQLITE_STATUS_MALLOC_COUNT, bp+568 /* &iCur */, bp+572 /* &iHi */, 0)
		libc.Xprintf(tls, ts+25048 /* "-- Outstanding A..." */, libc.VaList(bp+520, *(*int32)(unsafe.Pointer(bp + 568 /* iCur */)), *(*int32)(unsafe.Pointer(bp + 572 /* iHi */))))
		sqlite3.Xsqlite3_status(tls, SQLITE_STATUS_PAGECACHE_OVERFLOW, bp+568 /* &iCur */, bp+572 /* &iHi */, 0)
		libc.Xprintf(tls, ts+25093 /* "-- Pcache Overfl..." */, libc.VaList(bp+536, *(*int32)(unsafe.Pointer(bp + 568 /* iCur */)), *(*int32)(unsafe.Pointer(bp + 572 /* iHi */))))
		sqlite3.Xsqlite3_status(tls, SQLITE_STATUS_MALLOC_SIZE, bp+568 /* &iCur */, bp+572 /* &iHi */, 0)
		libc.Xprintf(tls, ts+25138 /* "-- Largest Alloc..." */, libc.VaList(bp+552, *(*int32)(unsafe.Pointer(bp + 572 /* iHi */))))
		sqlite3.Xsqlite3_status(tls, SQLITE_STATUS_PAGECACHE_SIZE, bp+568 /* &iCur */, bp+572 /* &iHi */, 0)
		libc.Xprintf(tls, ts+25180 /* "-- Largest Pcach..." */, libc.VaList(bp+560, *(*int32)(unsafe.Pointer(bp + 572 /* iHi */))))
	}
